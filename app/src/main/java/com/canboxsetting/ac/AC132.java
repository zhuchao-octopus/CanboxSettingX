 ...
 */
public class AC132 extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainView = inflater.inflate(R.layout.ac_shangqi_hiworld, container, false);
    ...
    private final static int[][] CMD_ID = new int[][]{{R.id.power, 0x01}, {R.id.ac, 0x02}, {R.id.dual, 0x3}, {R.id.ac_auto, 0x04}, {R.id.max, 0x05}, {R.id.rear, 0x06}, {R.id.inner_loop, 0x07},

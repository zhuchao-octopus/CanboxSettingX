...
public class AC134 extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater
				.inflate(R.layout.ac_chuaiqi_hiworld, container, false);
		...
		case 6:
			break;
		default:
			mMainView.findViewById(R.id.left_seat_heat)
					.setVisibility(View.GONE);
			mMainView.findViewById(R.id.right_seat_heat).setVisibility(
					View.GONE);
			break;
		}
		return mMainView;

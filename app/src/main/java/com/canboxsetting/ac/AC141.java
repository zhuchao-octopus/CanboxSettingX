...
public class AC141 extends MyFragment {
    ...
    MsgInterface mMsgInterface2 = new MsgInterface() {
        ...
        public void callBack(int msg) {
            ...
            int index = ((mCommonUpdateView.getAirData(9) & 0xff) << 8) | (mCommonUpdateView.getAirData(10) & 0xff);
            if (index != 0) {
                ((TextView) mMainView.findViewById(R.id.energy_statistics)).setText(index + "W");
            }
            index = (mCommonUpdateView.getAirData(11) & 0xff);
            if (index != 0) {
                ((TextView) mMainView.findViewById(R.id.str_air_quality_sensor)).setText(getString(R.string.str_air_quality_sensor) + ":" + index);
            }
        }
    };

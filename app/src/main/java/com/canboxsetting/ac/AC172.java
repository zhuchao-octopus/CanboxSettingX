 ...
 */
public class AC172 extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainView = inflater.inflate(R.layout.ac_dongfeng_hiworld, container, false);
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.power, 0x1}, {R.id.ac, 0x2}, {R.id.ac_auto, 0x4},
            ...
            //			{ R.id.wind_up1, 0x2a0 },
            {R.id.wind_horizontal1, 0x1a}, {R.id.wind_horizontal_down, 0x1b}, {R.id.wind_down1, 0x1d}, {R.id.wind_up_down, 0x1c},

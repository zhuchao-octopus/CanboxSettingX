...
public class AC197 extends MyFragment {
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.front, 0xac05}, {R.id.rear, 0xac06},

            {R.id.dual, 0xac18}, {R.id.wind_minus, 0xac36}, {R.id.wind_add, 0xac35},

            {R.id.ac_auto, 0xac17},


            {R.id.con_left_temp_up, 0xac31}, {R.id.con_left_temp_down, 0xac32}, {R.id.con_right_temp_up, 0xac33}, {R.id.con_right_temp_down, 0xac34},


            {R.id.wind_horizontal1, 0xac38}, {R.id.wind_down1, 0xac39}, {R.id.wind_up1, 0xac37},


            {R.id.left_seat_heat, 0xac3a}, {R.id.right_seat_heat, 0xac3b}, {R.id.left_seat_refrigeration, 0xac3c}, {R.id.right_seat_refrigeration, 0xac3d},
            ...
            {R.id.wind_minus_rear, 0xac15}, {R.id.wind_add_rear, 0xac16},

            {R.id.con_left_temp_rear_up, 0xac14}, {R.id.con_left_temp_rear_down, 0xac13},

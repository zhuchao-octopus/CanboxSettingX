...
//		mMainView.findViewById(R.id.ac_auto_rear).setVisibility(View.INVISIBLE);
	...
	private final static int[][] CMD_ID = new int[][] { 
		{ R.id.off, 0x01 },
			...
			{ R.id.rear_lock, 0x22 },
			{ R.id.mode_right, 0x24 },
			{ R.id.wind_mode_right, 0x24 },
			...
			{ R.id.power_rear, 0x2e },
			{ R.id.ac_auto_rear, 0x3a },
			

			{ R.id.mode_rear, 0x3e },
			{ R.id.air_control_forest_forest_normal, 0x38 },
			{ R.id.air_control_automatic_fog_removal_normal, 0x39 },

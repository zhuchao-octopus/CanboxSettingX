...
public class AC232 extends MyFragment {
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.con_left_temp_up, 0x2}, {R.id.con_left_temp_down, 0x3}, {R.id.wind_add, 0x4}, {R.id.wind_minus, 0x5},

            {R.id.inner_loop_in, 0x6}, {R.id.power, 0x7},

            {R.id.wind_down1, 0x8}, {R.id.wind_horizontal1, 0x9}, {R.id.wind_up_down, 0xa},

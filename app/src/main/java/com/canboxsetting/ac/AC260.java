 ...
 */
public class AC260 extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainView = inflater.inflate(R.layout.ac_weichai_hiworld, container, false);
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.power, 1}, {R.id.max, 0x5}, {R.id.rear, 0x6}, {R.id.inner_loop, 0x7}, {R.id.wind_add, 0xb}, {R.id.wind_minus, 0xc},


            {R.id.con_left_temp_up, 0xd}, {R.id.con_left_temp_down, 0xe},


            {R.id.wind_down1, 0x1d}, {R.id.wind_horizontal1, 0x1a}, {R.id.wind_horizontal_down, 0x1b},

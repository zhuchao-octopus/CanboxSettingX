...
public class AC285 extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainView = inflater.inflate(R.layout.ac_toyota_xinfeiyang, container, false);
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.ac_auto, 0x02}, {R.id.rear, 0x04},

            {R.id.dual, 0x8},


            {R.id.con_left_temp_up, 0x09}, {R.id.con_left_temp_down, 0x0a}, {R.id.con_right_temp_up, 0xb}, {R.id.con_right_temp_down, 0xc},


            {R.id.left_seat_heat, 0xd}, {R.id.right_seat_heat, 0xe},

            {R.id.pollen_clear, 0xf},

            {R.id.ac, 0x10}, {R.id.mode, 0x11},

            {R.id.wind_add, 0x14}, {R.id.wind_minus, 0x15},
            ...
            {R.id.con_left_temp_rear_up, 0x2b}, {R.id.con_left_temp_rear_down, 0x2c},


            {R.id.wind_add_rear, 0x2d}, {R.id.wind_minus_rear, 0x2e},

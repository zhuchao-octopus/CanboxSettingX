...
public class AC289 extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater
				.inflate(R.layout.ac_skyworth_od, container, false);
						...
						if ("ac".equals(cmd)) {
							...
							if (buf != null) {
								...
								mCommonUpdateView.postChanged(
										...
										0, 0, buf);
								try {
									setTemp(R.id.air_indoor_temp,R.string.air_indoor_temp,
											buf[10] & 0xff);
									setTemp(R.id.air_exterior_temp,R.string.air_exterior_temp,
											buf[11] & 0xff);
								} catch (Exception e) {

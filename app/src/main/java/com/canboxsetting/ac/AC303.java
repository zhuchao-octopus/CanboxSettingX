 ...
 */
public class AC303 extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainView = inflater.inflate(R.layout.ac_nissan05_xinchi, container, false);
    ...
    private void sendCanboxKey0x82(int d0) {
        sendCanboxInfo(0x71, d0, 1);
        Util.doSleep(200);
        sendCanboxInfo(0x71, d0, 0);
    }
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.ac_auto, 0x01}, {R.id.dual, 0x2}, {R.id.inner_loop, 0x03}, {R.id.max, 0x04}, {R.id.rear, 0x05},

            {R.id.wind_minus, 0x7}, {R.id.wind_add, 0x6},

            {R.id.ac, 0x08}, {R.id.mode, 0x9},

            {R.id.power, 0x0a},


            {R.id.con_left_temp_up, 0xc}, {R.id.con_left_temp_down, 0xd}, {R.id.con_right_temp_up, 0xe}, {R.id.con_right_temp_down, 0xd},
    ...
    public void onResume() {
        ...
        super.onResume();
        byte[] buf = new byte[]{(byte) 0x90, 2, 0x28, 0};
        BroadcastUtil.sendCanboxInfo(getActivity(), buf);
    }

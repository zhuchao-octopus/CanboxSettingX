...
public class CommonUpdateView extends Handler {
	...
	void setAirCondtionTitle(View view) {
		...
		updateSelect(R.id.air_control_automatic_fog_removal_normal,
				mAirData[9] & 0x10);
		...
		if (view.findViewById(R.id.inner_loop) != null) {
			...
			if ((mAirData[4] & 0x80) != 0
					&& view.findViewById(R.id.inner_loop_auto) == null) {
				if (((ImageView) view.findViewById(R.id.inner_loop)) != null) {
					((ImageView) view.findViewById(R.id.inner_loop))
	...
	void setAirCondtionWind(View view) {
		...
		updateSelect(R.id.wind_horizontal_down,
				(mAirData[1] & 0x60) == 0x60 ? 1 : 0);
		...
		for (int i = 0; i < 0xf; i++) {
			if (view.findViewById(R.id.wind_rate_1 + i) != null) {
				if (i < (mAirData[1] & 0x0F)) {
					...
					if ((mAirData[1] & 0x0F) >= 7
							&& (mAirData[1] & 0x0F) <= 0xf) {
						if (((ImageView) view
								.findViewById(R.id.wind_rate_1 + i)) != null) {
							((ImageView) view
									.findViewById(R.id.wind_rate_1 + i))
									.setVisibility(View.VISIBLE);
						}
		...
		for (int i = 0; i < 0xc; i++) {
			if (view.findViewById(R.id.wind_rate_rear_1 + i) != null) {
				if (i < (mAirData[11] & 0x0F)) {
					if (((ImageView) view.findViewById(R.id.wind_rate_rear_1
							+ i)) != null) {
						((ImageView) view.findViewById(R.id.wind_rate_rear_1
	...
	void setAirCondtionTemperature(View view) {
		...
		if (view.findViewById(R.id.right_temp) != null) {
			if ((mAirData[5] & 0x4) == 0) {
				...
				view.findViewById(R.id.right_temp)
		...
		if (view.findViewById(R.id.reartemp) != null) {
			if (backSeatTemp == 0x00) {
				((TextView) view.findViewById(R.id.reartemp))
						.setText(R.string.LO);
				...
				((TextView) view.findViewById(R.id.reartemp))
						.setText((backSeatTemp - 0xf0) + "");
			} else {
				((TextView) view.findViewById(R.id.reartemp))
						.setText(getAirTemperature(view, backSeatTemp));
			}
		}
		...
		if (view.findViewById(R.id.reartemp_right) != null) {
			...
			if (backSeatTemp == 0x00) {
				((TextView) view.findViewById(R.id.reartemp_right))
						.setText(R.string.LO);
			} else if (backSeatTemp == 0xff) {
				((TextView) view.findViewById(R.id.reartemp_right))
						.setText(R.string.HI);

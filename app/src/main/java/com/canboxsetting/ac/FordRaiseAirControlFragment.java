...
public class FordRaiseAirControlFragment extends MyFragment {
	...
	private final static int[][] CMD_ID = new int[][] { 
		{ R.id.power, 0x1 },
			...
			{ R.id.rear, 0x6 },
			{ R.id.dual, 0x18 }, 
			{ R.id.wind_minus, 0x1f },
			{ R.id.wind_add, 0x1e },

			{ R.id.ac_auto, 0x17 },
			{ R.id.wheel, 0xb },

			{ R.id.con_left_temp_up, 0x1a },
			{ R.id.con_left_temp_down, 0x1b },
			{ R.id.con_right_temp_up, 0x1c },
			{ R.id.con_right_temp_down, 0x1d },
			...
			{ R.id.left_seat_heat, 0x7 },
			{ R.id.right_seat_heat, 0x9 },
			{ R.id.left_seat_refrigeration, 0x8 },
			{ R.id.right_seat_refrigeration, 0xa },
			
			{ R.id.off_rear, 0x11 },

			{ R.id.rear_lock, 0x12 },
			{ R.id.wind_minus_rear, 0x15 }, 
			{ R.id.wind_add_rear, 0x16 },

			{ R.id.con_left_temp_rear_up, 0x14 },
			{ R.id.con_left_temp_rear_down, 0x13 },
	};

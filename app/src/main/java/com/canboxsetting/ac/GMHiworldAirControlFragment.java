...
public class GMHiworldAirControlFragment extends MyFragment {
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.wind_horizontal1, 0xff09}, {R.id.wind_down1, 0xff0a}, {R.id.wind_up1, 0xff05}, {R.id.wind_horizontal_down, 0xff21}, {R.id.wind_up_down, 0xff22},
            ...
            {R.id.con_left_temp_rear_up, 0x0116}, {R.id.con_left_temp_rear_down, 0x0216},

            {R.id.wind_horizontal1_rear, 0xff14}, {R.id.wind_down1_rear, 0xff12}, {R.id.wind_horizontal_down_rear, 0xff13},

            {R.id.ac_auto_rear, 0xff11},


            {R.id.wind_minus_rear, 0x0215}, {R.id.wind_add_rear, 0x0115},

...
public class Golf7SimpleAirControlFragment extends MyFragment {
    ...
    private final static int[][] CMD_ID = new int[][]{
            {R.id.air_title_ce_max, 0xbb03}, {R.id.ac_profile, 0xb100}, {R.id.air_title_ce_rear_lock, 0x1a200}, {R.id.air_title_ce_aqs, 0x1b000}, {R.id.air_title_ce_ac_1, 0x1be01},
            {R.id.air_title_ce_inner_loop, 0xbf00}, {R.id.air_title_ce_auto_large, 0xbb01}, {R.id.air_title_ce_ac_max, 0xbb02}, {R.id.wheel, 0x1AC00}, {R.id.con_left_temp_up, 0xb801},
            {R.id.con_left_temp_down, 0xb800}, {R.id.con_right_temp_up, 0xb901}, {R.id.con_right_temp_down, 0xb900}, {R.id.canbus21_mode1, 0x1b4ff}, {R.id.canbus21_mode3, 0x1b5ff},

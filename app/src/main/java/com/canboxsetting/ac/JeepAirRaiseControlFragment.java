...
public class JeepAirRaiseControlFragment extends MyFragment {
	...
	private final static int[][] CMD_ID = new int[][] {
		...
		{ R.id.wind_minus, 0x1c },
		{ R.id.wind_add, 0x1d },
		{ R.id.con_left_temp_up, 0x1f },
		{ R.id.con_left_temp_down, 0x1e },
		{ R.id.con_right_temp_up, 0x21 },
		{ R.id.con_right_temp_down, 0x20 },

		{ R.id.left_seat_heat, 0x30 },
		{ R.id.right_seat_heat, 0x32 },
		

		{ R.id.left_seat_refrigeration, 0x31 },
		{ R.id.right_seat_refrigeration, 0x33 },
		{ R.id.wheel, 0x34 },

 ...
 */
public class JiLiACRaiselFragment extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainView = inflater.inflate(R.layout.ac_jili_raise, container, false);
    ...
    private void sendCanboxInfo0x95(int d0, int d1) {
        byte[] buf = new byte[]{(byte) 0x8a, 0x6, 0, 0, 0, 0, 0, 0};
        buf[2 + d0] = (byte) d1;
        BroadcastUtil.sendCanboxInfo(getActivity(), buf);
    }
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.power, 0x80}, {R.id.mode, 0x40}, {R.id.ac_auto, 0x20}, {R.id.max, 0x10}, {R.id.ac, 0x02}, {R.id.ac_max, 0x01},

            {R.id.inner_loop, 0x201}, {R.id.inner_loop_auto, 0x580}, {R.id.rear, 0x104}, {R.id.dual, 0x108},
            ...
            {R.id.wind_minus, 0x100}, {R.id.wind_add, 0x100},

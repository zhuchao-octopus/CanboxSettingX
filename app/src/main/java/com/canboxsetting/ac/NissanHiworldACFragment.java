...
public class NissanHiworldACFragment extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainView = inflater.inflate(R.layout.ac_nissan_world, container, false);
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.wind_up1, 0x8}, {R.id.wind_horizontal1, 0x9}, {R.id.wind_horizontal_down, 0x1b}, {R.id.wind_down1, 0xa}, {R.id.wind_up_down, 0x1c},

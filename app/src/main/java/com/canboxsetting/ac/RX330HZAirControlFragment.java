...
public class RX330HZAirControlFragment extends MyFragment {
	...
	{ R.id.air_perple, 0x0803 }, { R.id.wind_up1, 0x1200 },
			{ R.id.wind_up2, 0x1200 },

			{ R.id.air_title_ce_max, 0x1203 }, { R.id.icon_power, 0x01ff },

			{ R.id.con_left_temp_up, 0x0301 },
			{ R.id.con_left_temp_down, 0x0200 },
			{ R.id.con_right_temp_up, 0x0501 },
			{ R.id.con_right_temp_down, 0x0400 },

			{ R.id.wind_minus, 0x0900 }, { R.id.wind_add, 0x0a00 },

			{ R.id.canbus21_mode1, 0x0700 }, { R.id.canbus21_mode3, 0x0800 },

			{ R.id.air_title_sync, 0x1000 },
			{ R.id.air_title_ce_ac_max, 0x1300 },

			{ R.id.air_title_ce_auto_large, 0x1501 },
			{ R.id.air_title_ce_rear, 0x1400 },
			{ R.id.air_title_ce_ac_1, 0x1701 },
			{ R.id.air_title_ce_inner_loop, 0x1900 },

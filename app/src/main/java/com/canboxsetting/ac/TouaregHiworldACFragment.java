...
public class TouaregHiworldACFragment extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater.inflate(R.layout.ac_touareg_hiworld, container,
				false);
	...
	private final static int[][] CMD_ID = new int[][] {
			{ R.id.icon_power, 0x106ff }, { R.id.air_title_ce_aqs, 0x10100 },
			{ R.id.air_title_ce_auto_large, 0x10200 },
			{ R.id.air_title_ce_max, 0x10b00 },
			{ R.id.wheel, 0x10a00 },
			{ R.id.canbus21_mode1, 0x10400 },
			{ R.id.canbus21_mode3, 0x10500 },
			{ R.id.canbus21_mode5, 0x10300 },

			{ R.id.point0, 0x0701 }, { R.id.point1, 0x0702 },
			{ R.id.point2, 0x0703 }, { R.id.point3, 0x0704 },
			{ R.id.point4, 0x0705 }, { R.id.point5, 0x0706 },
			{ R.id.point6, 0x0707 },

			{ R.id.wind_minus, 0x0700 }, { R.id.wind_add, 0x0700 },

			{ R.id.con_left_temp_up, 0x10800 },
			{ R.id.con_left_temp_down, 0x10800 },
			{ R.id.con_right_temp_up, 0x10900 },
			{ R.id.con_right_temp_down, 0x10900 },
...
//				temperature = (byte) ((15.5f + (0.5f * temperature)) * 2);
	...
	private void updateAuto(int i) {
		...
		((ImageView) mMainView.findViewById(R.id.air_title_ce_auto_large))
				.setImageResource(i);
	}
	...
	private void updateView(byte[] buf) {
		...
		case 0x31:
			...
			if (buf[7] == 0xb || buf[7] == 0xc || buf[7] == 0xd
					|| buf[7] == 0xe) {
			...
			if (buf[7] == 0x3 || buf[7] == 0xc || buf[7] == 0x5
					|| buf[7] == 0xe) {
			...
			if (buf[7] == 0x5 || buf[7] == 0x6 || buf[7] == 0xd
					|| buf[7] == 0xe) {

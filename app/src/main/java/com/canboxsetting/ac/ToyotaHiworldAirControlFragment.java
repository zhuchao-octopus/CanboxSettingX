 ...
 */
public class ToyotaHiworldAirControlFragment extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainView = inflater.inflate(R.layout.ac_toyota_hiworld, container, false);
    ...
    private void sendCanboxInfo0xc7(int d0) {
        byte[] buf = new byte[]{0x2, (byte) 0x3d, (byte) d0, 1};
    ...
    private void sendCanboxInfo0x90(int d0) {
        byte[] buf = new byte[]{0x3, (byte) 0x90, 0x2, (byte) d0, 0};
        BroadcastUtil.sendCanboxInfo(getActivity(), buf);
    }
    ...
    private final static int[][] CMD_ID = new int[][]{
            ...
            {R.id.dual, 0x29}, {R.id.rear_lock, 0x22}, {R.id.air_purification, 0x19},
            ...
            {R.id.con_left_temp_rear_up, 0x40}, {R.id.con_left_temp_rear_down, 0x41},

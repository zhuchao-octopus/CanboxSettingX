 ...
 */
public class ToyotaLuZhengAirControlFragment extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater
				.inflate(R.layout.ac_toyota_luzheng, container, false);
	...
	private final static int[][] CMD_ID = new int[][] {
		{ R.id.power, 1 }, 
		{ R.id.con_left_temp_up, 3 },
		{ R.id.con_left_temp_down, 2 },
		{ R.id.con_right_temp_up, 5 },
		{ R.id.con_right_temp_down, 4 },
		...
		{ R.id.air_fwindow_heat, 0x1a }, 

		{ R.id.windshield_deicing, 0x1c },
		{ R.id.swing, 0x1d },
		{ R.id.pollen_clear, 0x20 },
...
//		{ R.id.ac_max, 0x0010 }, 
		...
		{ R.id.mode_rear, 0x2b },
		{ R.id.con_right_temp_rear_up, 0x2f },
		{ R.id.con_right_temp_rear_down, 0x2e },
		
		{ R.id.power_rear, 0x2c },


		{ R.id.wind_minus_rear, 0x29 }, 
		{ R.id.wind_add_rear, 0x28 },
		
		
		{ R.id.con_left_temp_rear_up, 0x26 },
		{ R.id.con_left_temp_rear_down, 0x27 },
		{ R.id.ac_auto_rear, 0x2d }, 

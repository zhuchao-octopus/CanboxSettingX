...
public class VWMQBACHiworldFragment extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainView = inflater.inflate(R.layout.ac_vwmqb_hiwordl, container, false);
    ...
    private final static int[][] CMD_ID = new int[][]{{R.id.power, 0x2}, {R.id.inner_loop_auto, 0x0e}, {R.id.ac, 0xf}, {R.id.sync, 0x11}, {R.id.rear_lock, 0x12}, {R.id.ac_max, 0x8101}, {R.id.ac_auto, 0x8100}, {R.id.max, 0x8102}, {R.id.inner_loop, 0x0113},
            ...
            {R.id.wheel, 0x23}, {R.id.wind_down1_rear, 0x2a01}, {R.id.wind_horizontal1_rear, 0x2a02}, {R.id.wind_horizontal_down_rear, 0x2a03},

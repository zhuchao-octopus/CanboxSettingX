...
public class FordRaiseCDFragment extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater
				.inflate(R.layout.rx330_cd_player, container, false);
		((ImageView) mMainView.findViewById(R.id.pp))
	...
	private void updateView(byte[] buf) {
		...
		case 0x65: {
			...
			if (buf[2] == 2) {
				s = String.format("%d/%d", ((buf[3] & 0xff) << 8)
						| (buf[4] & 0xff), ((buf[5] & 0xff) << 8)
						| (buf[6] & 0xff));
		...
		case 0x66: {
			s = String.format("%02d:%02d:%02d/%02d:%02d:%02d", (buf[5] & 0xff),
					(buf[6] & 0xff), (buf[7] & 0xff), (buf[2] & 0xff),

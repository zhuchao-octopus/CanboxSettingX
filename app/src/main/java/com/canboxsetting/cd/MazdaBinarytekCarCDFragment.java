    ...
    private void updateView(byte[] buf) {
        ...
        switch (buf[0]) {
            case 0x61: {
                ...
                String s = String.format("%02d:%02d:%02d/%02d:%02d:%02d", (buf[11] & 0xff), (buf[12] & 0xff), (buf[13] & 0xff), (buf[8] & 0xff), (buf[9] & 0xff), (buf[10] & 0xff));
            ...
            case 0x5: {
                ...
                String s = String.format("%02d:%02d:%02d/%02d:%02d:%02d", c / 3600, (c / 60) % 60, c % 60, t / 3600, (t / 60) % 60, t % 60);

...
public class RX330HZCarCDFragment extends MyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainView.findViewById(R.id.freq_1).setOnLongClickListener(mOnLongClickListenerRadio);
        mMainView.findViewById(R.id.freq_2).setOnLongClickListener(mOnLongClickListenerRadio);
        mMainView.findViewById(R.id.freq_3).setOnLongClickListener(mOnLongClickListenerRadio);
        mMainView.findViewById(R.id.freq_4).setOnLongClickListener(mOnLongClickListenerRadio);
        mMainView.findViewById(R.id.freq_5).setOnLongClickListener(mOnLongClickListenerRadio);
        mMainView.findViewById(R.id.freq_6).setOnLongClickListener(mOnLongClickListenerRadio);
        showUI(0);
    ...
    private void showCarPlayerUI(int i, byte[] buf) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                ((TextView) mMainView.findViewById(R.id.car_status)).setText(R.string.fam);
                updateRaidoUI(buf);
                break;
            case 2:

                ((TextView) mMainView.findViewById(R.id.car_status)).setText(R.string.button_text_disc);
                if (mCD) {
                    mMainView.findViewById(R.id.off).setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.shuffle) {
            ...
            if (mMainView.findViewById(R.id.dvd_lang_main).getVisibility() == View.VISIBLE) {
                ...
                mMainView.findViewById(R.id.dvd_lang_main).setVisibility(View.VISIBLE);
            }
    ...
    private void updateCDUI(byte[] buf) {
        if (buf != null) {
            ...
            String s = String.format("%02d:%02d:%02d/%02d:%02d:%02d", (buf[13] & 0xff), (buf[14] & 0xff), (buf[15] & 0xff), (buf[10] & 0xff), (buf[11] & 0xff), (buf[12] & 0xff));
            ...
            if ((buf[5] & 0xf0) == 0x0) {
                ...
                ((ImageView) mMainView.findViewById(R.id.repeat_tag)).setImageResource(R.drawable.common_repeat_tag);
            } else {
                mMainView.findViewById(R.id.repeat_tag).setVisibility(View.VISIBLE);
                ((ImageView) mMainView.findViewById(R.id.repeat_tag)).setImageResource(R.drawable.common_repeat1_tag);
            }
    ...
    private void updateRaidoUI(byte[] buf) {
        if (buf != null) {
            if (buf[1] == 6) {
                ...
                ((TextView) mMainView.findViewById(R.id.freq_text1)).setText(freq);
    ...
    private void setFreq(int id, int f, boolean fm) {
        String freq;
        if (fm) {
            freq = String.format(Locale.ENGLISH, "%d.%02d MHz", f / 100, f % 100);
        } else {
            freq = f + " KHz";
        }
    ...
    private void updateView(byte[] buf) {
        ...
        switch (buf[0]) {
            ...
            case 0x61: {
                ...
                String ss[] = getActivity().getResources().getStringArray(R.array.disc_status);
                if (mPlayStatus != 0xf) {
                ...
                ss = getActivity().getResources().getStringArray(R.array.rx330_languages);
            ...
            case 0x21: {
                s = "";
                String ss[] = getActivity().getResources().getStringArray(R.array.usb_status);

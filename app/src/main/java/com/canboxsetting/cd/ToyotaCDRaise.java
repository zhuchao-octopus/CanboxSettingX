...
public class ToyotaCDRaise extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater.inflate(R.layout.crown12_car_cd_player, container,
				false);
		...
		case 0x62:
			if (buf[2] == 2) {
				...
				if (buf[3] == 0) {
					...
					s = String.format("%02d:%02d:%02d", (buf[13] & 0xff),
							(buf[14] & 0xff), (buf[15] & 0xff));

					((TextView) mMainView.findViewById(R.id.str_play_time))
							.setText(s);
					...
					try {
						s = new String(data, "GBK");
						((TextView) mMainView.findViewById(R.id.artist))
								.setText(s);
					} catch (Exception e) {

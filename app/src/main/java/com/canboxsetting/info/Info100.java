...
public class Info100 extends PreferenceFragmentCompat {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("drive_motor_controller_temperature", 0), new NodePreference("drive_motor_temperature", 0),


            new NodePreference("lowest_voltage_unit", 0), new NodePreference("highest_voltage_unit", 0),

            new NodePreference("single_minimum_voltage_group_number", 0), new NodePreference("highest_voltage_group_number", 0),

            new NodePreference("battery_pack_minimum_temperature", 0), new NodePreference("battery_pack_maximum_temperature", 0),

            new NodePreference("battery_group_minimum_temperature_group", 0), new NodePreference("battery_group_maximum_temperature_group", 0),

            new NodePreference("remaining_power", 0),


            new NodePreference("battery_pack_charge_discharge_status", 0), new NodePreference("bms_charge_discharge_status", 0),

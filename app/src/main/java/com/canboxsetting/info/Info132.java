...
public class Info132 extends PreferenceFragment {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("mileage_sum", 0x34), new NodePreference("average_fule_consumption_the_last_250km", 0x34), new NodePreference("average_power_consumption_the_last_250km", 0x34),
            new NodePreference("mileage", 0x34), new NodePreference("estimate_range_electricity", 0x34),

...
public class Info199 extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater.inflate(R.layout.opel_haozheng_info, container,
				false);
	...
	private final static String TITLE[] = { " ", "BC:", "Settings:", "Sound:",
			"stations:", "store:", "Tracks:", "Extras:", };
	...
	private void updateView(byte[] buf) {
		...
		try {
			...
			case 7:
				...
				((TextView) mMainView.findViewById(R.id.title1))
						.setText(mTitle0 + "  " + temp);
				break;
			case 0xb:
				temp = TITLE[((buf[3] & 0xf)) - 0xa + 2];
				temp = temp + "  " + getBufString(buf, 4, buf[1]-2);
				((TextView) mMainView.findViewById(R.id.title2))
						.setText(temp);
				break;
			case 0x12:
			...
			case 0x13:
				i = (int) (((buf[2] & 0xff) << 24) | ((buf[3] & 0xff) << 16)
						| ((buf[4] & 0xff) << 8) | ((buf[5] & 0xff) << 0));
				temp = String.format("%d.%d KM", i / 10, i % 10);

				((TextView) mMainView.findViewById(R.id.mileage1))
						.setText(temp);

				i = (int) (((buf[7] & 0xff) << 24) | ((buf[8] & 0xff) << 16)
				...
				((TextView) mMainView.findViewById(R.id.averagefuel))
						.setText(temp);
			...
			case 0x14:
				...
				((TextView) mMainView.findViewById(R.id.averagefuel3))
						.setText(temp);

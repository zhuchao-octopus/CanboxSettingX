...
public class Info202 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater.inflate(R.layout.dorcen_e20_kld, container,
				false);
...
//			i = ((int) buf[10] & 0xff) * 256 + ((int) buf[11] & 0xff);
			...
			((TextView) mMainView.findViewById(R.id.am_cellvoltage))
					.setText(temp);
			...
			if ((buf[8] & 0x10) == 0) {
				((TextView) mMainView
						.findViewById(R.id.cleaning_liquid_alarm))
						.setTextColor(Color.WHITE);
				((TextView) mMainView
						.findViewById(R.id.cleaning_liquid_alarm))
				...
				((TextView) mMainView
						.findViewById(R.id.cleaning_liquid_alarm))
						.setText(R.string.am_low);
			}
			break;
		case 0x72:
			if ((buf[2] & 0x08) != 0) {
				((TextView) mMainView.findViewById(R.id.am_handbrake))
						.setText(R.string.am_stop);
				((TextView) mMainView.findViewById(R.id.am_handbrake))
						.setTextColor(Color.RED);
			} else {
				((TextView) mMainView.findViewById(R.id.am_handbrake))
						.setText(R.string.am_nostop);
				((TextView) mMainView.findViewById(R.id.am_handbrake))
						.setTextColor(Color.WHITE);
			}
			break;
		case 0x13:
			...
			temp = (((int) buf[10] & 0xff) * 256 + ((int) buf[11] & 0xff))
					+ "RPM";
		...
		case 0x41:
			...
			case 0x2:
				...
				if (((TextView) mMainView.findViewById(R.id.am_runningspeed)) != null) {
					((TextView) mMainView.findViewById(R.id.am_runningspeed))
							.setText(temp);
				}

				i = ((int) buf[3] & 0xff) * 5;
				temp = String.format("%d", i / 10);
				temp += "%";
				((TextView) mMainView.findViewById(R.id.am_cellvoltage))
						.setText(temp);

				// i = ((int) buf[9] & 0xff) * 256 + ((int) buf[10] & 0xff);
				i = (short) (((buf[9] & 0xff) - 110)*5);
				temp = String.format("%d.%01d °C", i / 10, i % 10);

				((TextView) mMainView.findViewById(R.id.outt)).setText(temp);

				i = ((int) buf[6] & 0xff) * 0x10000 + ((int) buf[7] & 0xff)
						* 256 + ((int) buf[8] & 0xff);
				temp = i + " KM";

				((TextView) mMainView.findViewById(R.id.am_mileage))
						.setText(temp);

				((TextView) mMainView.findViewById(R.id.beoilmass))
						.setText(((int) (buf[5] & 0xff)*10) + "wh/km");
				break;
			...
			case 0x1:
				...
				if ((buf[4] & 0xff) == 1) {
					...
					((TextView) mMainView
							.findViewById(R.id.cleaning_liquid_alarm))
							.setText("P");
				} else if ((buf[4] & 0xff) == 2) {
					
					((TextView) mMainView
							.findViewById(R.id.cleaning_liquid_alarm))
							.setText("R");
				} else if ((buf[4] & 0xff) == 3) {
					
					((TextView) mMainView
							.findViewById(R.id.cleaning_liquid_alarm))
							.setText("N");
				} else if ((buf[4] & 0xff) == 4) {

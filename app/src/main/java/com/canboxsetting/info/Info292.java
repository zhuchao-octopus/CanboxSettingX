...
public class Info292 extends PreferenceFragment {
	...
	private static final NodePreference[] NODES = {
		...
		new NodePreference("camry_distance_1", 0),
		new NodePreference("mileage_sum", 0),
		new NodePreference("water_temp", 0),
		new NodePreference("engine_speed", 0),
	...
	private void updateView(byte[] buf) {
		...
		case 0x40:
			...
			setPreference(NODES[0].mKey,
					(((buf[8] & 0xff) << 8) | (buf[9] & 0xff)) + "KM");
			
			setPreference(NODES[1].mKey,
					(((buf[10] & 0xff) << 16) |((buf[11] & 0xff) << 8) | (buf[12] & 0xff)) + "KM");

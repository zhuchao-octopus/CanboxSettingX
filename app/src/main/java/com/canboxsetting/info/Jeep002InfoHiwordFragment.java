...
public class Jeep002InfoHiwordFragment extends PreferenceFragmentCompat implements OnPreferenceClickListener {
    private static final String TAG = "Jeep002InfoHiwordFragment";
    //初始化命令
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.jeep002_hiworld_info);
    }

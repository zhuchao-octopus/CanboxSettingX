...
public class JeepInfoSimpleFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findPreference("tripa1").setTitle(
				getString(R.string.trip_a1) + " "
						+ getString(R.string.averagefuel));
		findPreference("tripa2").setTitle(
				getString(R.string.trip_a1) + " "
						+ getString(R.string.averageapeed));
		findPreference("tripa3").setTitle(
				getString(R.string.trip_a1) + " "
						+ getString(R.string.mileage1));
		findPreference("tripa4").setTitle(
				getString(R.string.trip_a1) + " "
						+ getString(R.string.traveltime1));

		findPreference("tripb1").setTitle(
				getString(R.string.trip_b1) + " "
						+ getString(R.string.averagefuel));
		findPreference("tripb2").setTitle(
				getString(R.string.trip_b1) + " "
						+ getString(R.string.averageapeed));
		findPreference("tripb3").setTitle(
				getString(R.string.trip_b1) + " "
						+ getString(R.string.mileage1));
		findPreference("tripb4").setTitle(
				getString(R.string.trip_b1) + " "
						+ getString(R.string.traveltime1));
	}
			...
			case 0x2:
				...
				if (index == 0xffff) {
					...
					s = bcd2Str((byte) ((buf[3] & 0xf0) >> 4))
							+ bcd2Str((byte) (buf[3] & 0x0f)) + "."
							+ bcd2Str((byte) ((buf[4] & 0xf0) >> 4))
							+ bcd2Str((byte) (buf[4] & 0x0f));

...
public class PSAInfoBagooFragment extends Fragment {
	...
	private void updateView(byte[] buf) {
		...
		try {
			...
			case 0x38:
				...
				if ((buf[2] & 0x4) == 0) {
					((TextView) mMainView.findViewById(R.id.am_safetybelt))
							.setText(R.string.am_buttoned);
					((TextView) mMainView.findViewById(R.id.am_safetybelt))
							.setTextColor(Color.WHITE);
				} else {
					((TextView) mMainView.findViewById(R.id.am_safetybelt))
							.setText(R.string.am_nobuttoned);
					((TextView) mMainView.findViewById(R.id.am_safetybelt))
							.setTextColor(Color.RED);
				}

				if ((buf[3] & 0x20) == 0) {
					((TextView) mMainView.findViewById(R.id.beoilmass))
							.setText(R.string.am_normal);
					((TextView) mMainView.findViewById(R.id.beoilmass))
							.setTextColor(Color.WHITE);
				} else {
					((TextView) mMainView.findViewById(R.id.beoilmass))
							.setText(R.string.electriclow);
					((TextView) mMainView.findViewById(R.id.beoilmass))
							.setTextColor(Color.RED);
				}
			case 0x33:

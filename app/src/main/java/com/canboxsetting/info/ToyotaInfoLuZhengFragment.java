...
public class ToyotaInfoLuZhengFragment extends PreferenceFragment implements
	...
	private final static int[] INIT_CMDS = { 0x2300, 0x2a00, 0x2b00,
			0x1f00,
	/*
				...
				public void onProgressChanged(SeekBar seekBar, int progress,
					...
					if (fromUser) {
						if (mTextVolume != null) {
							...
							byte[] buf = new byte[] { (byte) 0x84, 0x2, 0x07,
									(byte) progress };
							BroadcastUtil.sendCanboxInfo(getActivity(), buf);

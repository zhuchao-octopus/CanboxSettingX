...
public class VWMQBInfoHiwordFragment extends PreferenceFragment implements
	...
	private static final NodeDrivingHiworldData[] NODES_DRIVINGDATA = {
			new NodeDrivingHiworldData(R.string.since_start),
			new NodeDrivingHiworldData(R.string.long_term),
			new NodeDrivingHiworldData(R.string.since_refuelling) };
	...
	private void showDrivingData() {
		...
		setTextViewStringEx(mMainView.findViewById(R.id.driving_data),
				R.id.avg_speed, n.mAverageSpeed);
		setTextViewStringEx(mMainView.findViewById(R.id.driving_data),
				R.id.distance, n.mDrivenDistance);
		setTextViewStringEx(mMainView.findViewById(R.id.driving_data),
				R.id.travelling_time, n.mDrivenTime);
		setTextViewStringEx(mMainView.findViewById(R.id.driving_data),
				R.id.avg_consumption, n.mOilConsumption);

...
public class AccordSettingsBinaryTekFragment extends PreferenceFragment implements
	...
	private static final Node[] NODES = {
		...
		new Node("f_backlight", 0xc601, 0x32, 0x8000, 0x0),
		new Node("trip_a", 0xc602, 0x32, 0x30, 0x0),
		new Node("trip_b", 0xc603, 0x32, 0xc0, 0x0),
		

		new Node("interior", 0xc604, 0x32, 0x300, 0x0),
		new Node("headlight", 0xc605, 0x32, 0xc00, 0x0),
		new Node("auto_light", 0xc606, 0x32, 0x7000, 0x0),
		new Node("lock_with", 0xc607, 0x32, 0x30000, 0x0),
		new Node("unlock_with", 0xc608, 0x32, 0xc0000, 0x0),
		new Node("key_mode", 0xc609, 0x32, 0x400000, 0x0),
		new Node("keyless", 0xc60a, 0x32, 0x800000, 0x0),
		new Node("security", 0xc60b, 0x32, 0x300000, 0x0),
		new Node("beep_vol", 0xc60c, 0x32, 0x80000000, 0x0),		
		new Node("access_beep", 0xc60d, 0x32, 0x40000000, 0x0),

		new Node("remote_start_system", 0xc618, 0x32, 0x8000000, 0x0),
		new Node("screen1", 0xc641, 0x0, 0x00, 0x0),
		
		new Node("screen2", 0xc642, 0xd3, 0xff, 0x0),
		new Node("screen3", 0xc643, 0xd3, 0xff00, 0x0),
		new Node("screen4", 0xc644, 0xd3, 0xff0000, 0x0),

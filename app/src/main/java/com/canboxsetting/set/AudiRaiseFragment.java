...
public class AudiRaiseFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
    private static final String TAG = "HYSettingsRaiseFragment";

    private static final NodePreference[] NODES = {

            new NodePreference("radar_sound_switch", 0xc600, 0x25, 0x1, 0, R.array.radar_sound_switch_entries, R.array.three_values),
            new NodePreference("str_parking_assist", 0xc602, 0x25, 0x2, 0, R.array.parking_mode, R.array.three_values),
        ...
        for (int i = 0; i < NODES.length; ++i) {
            if (NODES[i].mKey.equals(key)) {
                if (preference instanceof ListPreference) {
                    ...
                    if (NODES[i].mKey.equals("str_parking_assist")) {

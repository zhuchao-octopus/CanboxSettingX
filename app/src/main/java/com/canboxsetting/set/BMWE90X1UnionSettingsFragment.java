...
public class BMWE90X1UnionSettingsFragment extends PreferenceFragment implements
		Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
	private static final String TAG = "BMWE90X1UnionSettingsFragment";

	private static final Node[] NODES = {

	new Node("range", 0x8200, 0x0401), new Node("lang", 0x8201, 0x0401),
			new Node("age_full", 0x8202, 0x0401),
			new Node("temp", 0x8203, 0x0401),

			new Node("lef_hot", 0x8501, 0x0), new Node("rif_hot", 0x8502, 0x0),
			new Node("redar", 0x8503, 0x0), new Node("curtain", 0x8504, 0x0),
	...
	private void sendCanboxData(int cmd, int value) {
		...
		String strTimeFormat = Settings.System.getString(getActivity()
				.getContentResolver(),
		...
		byte[] buf = new byte[] { (byte) ((cmd & 0xff00) >> 8), 0x05,
				mBufUnit[0], mBufUnit[1], mBufUnit[2], mBufUnit[3], t24 };

...
public class ChangChengRaiseSettingFragment extends PreferenceFragment
	...
	private static final Node[] NODES = {
		...
		new Node("precollision_warning_system_key", 0x8317, 0x3103, 0x80),
		new Node("automatic_emergency_braking_system_key", 0x8318, 0x3103, 0x40),
...
//		new Node("", 0x8304, 0x3103, 0x80),
//		new Node("", 0x8304, 0x3103, 0x80),
//		new Node("", 0x8304, 0x3103, 0x80),
//		new Node("", 0x8304, 0x3103, 0x80),
//		new Node("", 0x8304, 0x3102, 0x80),
//		new Node("", 0x8304, 0x3102, 0x80),
//		new Node("", 0x8304, 0x3102, 0x80),
//		new Node("", 0x8304, 0x3102, 0x80),
//		new Node("", 0x8304, 0x3102, 0x80),
...
//		new Node("", 0x8304, 0x3102, 0x80),
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.changcheng_settings_raise);

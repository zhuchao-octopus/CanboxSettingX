...
public class DaTongSettingsRaiseFragment extends PreferenceFragment implements
	...
	private static final Node[] NODES = {
		...
		new Node("key_flow_me_home", 0x8300, 0x5100, 0x80, 0x0),
		new Node("key_flow_me_home_times", 0x8301, 0x5100, 0x60, 0x0),
		new Node("key_unlock_near_car", 0x8302, 0x5100, 0x18, 0x0),
		new Node("key_driving_lock", 0x8303, 0x5100, 0x04, 0x0),
		new Node("key_unlock", 0x8304, 0x5100, 0x02, 0x0),
		new Node("key_unlock_mode", 0x8305, 0x5100, 0x01, 0x0),
		new Node("key_keyless_unlock", 0x8306, 0x5101, 0x80, 0x0),
		new Node("key_unlocks", 0x8307, 0x5101, 0x40, 0x0),
		new Node("key_rear_view_mirror_automatically_folded", 0x830a, 0x5101, 0x20, 0x0),
		new Node("key_speed_alarm", 0x8308, 0x5101, 0x10, 0x0),

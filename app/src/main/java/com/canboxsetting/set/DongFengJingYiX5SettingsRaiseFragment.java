...
public class DongFengJingYiX5SettingsRaiseFragment extends PreferenceFragment implements
	...
	private static final Node[] NODES = {
		new Node("dome_delay", 0x8000, 0x40000000, 0xc0, 0,
				Node.TYPE_BUFF2),
				
		new Node("saving_time", 0x8001, 0x40000000, 0x30, 0,
				Node.TYPE_BUFF2),
				
		new Node("str_speed_lock", 0x8002, 0x40000000, 0x8000, 0,
				Node.TYPE_BUFF2),
		
		new Node("the_automatic_lock", 0x8003, 0x40000000, 0x4000, 0,
				Node.TYPE_BUFF2),
		
		new Node("remote_lock_feedback", 0x8004, 0x40000000, 0x2000, 0,
				Node.TYPE_BUFF2),
		
		new Node("remote_window_closing", 0x8005, 0x40000000, 0x1000, 0,
				Node.TYPE_BUFF2),
				
		new Node("rear_view", 0x8006, 0x40000000, 0x0800, 0,
				Node.TYPE_BUFF2), 
		};

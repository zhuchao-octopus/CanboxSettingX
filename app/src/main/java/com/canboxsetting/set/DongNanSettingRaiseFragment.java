...
public class DongNanSettingRaiseFragment extends PreferenceFragment implements
	...
	private static final Node[] NODES = {
		new Node("steering_assist_photography", 0x8301, 0x40010000, 0x80, 0,
				Node.TYPE_BUFF1),
		
		new Node("turning_lighting", 0x8302, 0x40010000, 0x40, 0,
				Node.TYPE_BUFF1),
		
		new Node("blind_spot_warning", 0x8303, 0x40010000, 0x20, 0,
				Node.TYPE_BUFF1),
				
		new Node("show_when_reversing", 0x8304, 0x40010000, 0x10, 0,
				Node.TYPE_BUFF1),
		
		new Node("close_the_window_rainy_day", 0x8305, 0x40010000, 0x08, 0,
				Node.TYPE_BUFF1),
		};

...
public class FocusSettingsFragment extends PreferenceFragment implements
...
//		sendCanboxInfo(0xa2, mLedSeting);
	...
	private void updateView(byte[] buf) {
		...
		case 0x24:
			...
			((ListPreference) findPreference("warning_contorl"))
					.setValue(String.valueOf(index));
			((ListPreference) findPreference("warning_contorl"))
					.setSummary(((ListPreference) findPreference("warning_contorl"))
							.getEntry());
			...
			if ((buf[7] & 0x4) != 0) {
				((SwitchPreference) findPreference("parking_mode"))
						.setChecked(true);
			} else {
				((SwitchPreference) findPreference("parking_mode"))
						.setChecked(false);
			...
			if ((buf[7] & 0x40) != 0) {
				((SwitchPreference) findPreference("reverse_zoom"))
						.setChecked(true);
			} else {
				((SwitchPreference) findPreference("reverse_zoom"))
						.setChecked(false);

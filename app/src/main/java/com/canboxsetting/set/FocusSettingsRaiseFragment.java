...
public class FocusSettingsRaiseFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        try {
            if ("information_tone_volume".equals(key)) {
                ...
                sendCanboxInfo(0xc5, Integer.parseInt((String) newValue), m61[1]);
            } else {

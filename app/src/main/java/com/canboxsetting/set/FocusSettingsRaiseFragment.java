...
public class FocusSettingsRaiseFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final NodePreference[] NODES_NORMAL = {
            ...
            new NodePreference("ambient_light_color", 0xC5, 0x61, 0x7f, 5, R.array.atmosphere_raise_light_color_entries, R.array.eninstrument_style3_value), new NodePreference("ambient_light_brightness", 0xC5, 0x61, 0x7f, 5, 0, 100, 1),
    ...
    private static final NodePreference[] NODES_LINGJIE = {
            ...
            new NodePreference("ambient_light_color", 0xC5, 0x61, 0x7f, 5, R.array.atmosphere_bell_light_color_entries, R.array.eight_values), new NodePreference("ambient_light_brightness", 0xC5, 0x61, 0x7f, 5, 0, 100, 1),

...
public class FordSettingHiworldFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final Node[] NODES = {
            ////车辆设置
            new Node("trip_settings", 0x6C05, 0x67010000, 0x0400, 0, Node.TYPE_BUFF1),

            new Node("camera_delay", 0xF206, 0xE8010000, 0xFF0000, 0, Node.TYPE_BUFF1),

            new Node("bzs", 0x6D06, 0x68010000, 0x0100, 0, Node.TYPE_BUFF1),

            //		new Node("language_status", 0x3A0A, 0x35010000, 0x02000000, 0,
            //				Node.TYPE_BUFF1),

            new Node("traction_control_system", 0x8A03, 0x85010000, 0x0100, 0, Node.TYPE_BUFF1),

            new Node("turn_light", 0x6C03, 0x67010000, 0x0100, 0, Node.TYPE_BUFF1),

            new Node("message_tone", 0x6C06, 0x67010000, 0x0800, 0, Node.TYPE_BUFF1),

            new Node("waring_tone", 0x6C07, 0x67010000, 0x1000, 0, Node.TYPE_BUFF1),
            ...
            new Node("atmosphere_light_color", 0x6F03, 0x61010000, 0xFF0000, 0, Node.TYPE_BUFF1),

            new Node("temp47", 0x6D04, 0x68010000, 0x1000, 0, Node.TYPE_BUFF1),

            //		new Node("mfd_screen_brightness", 0x3A07, 0x35010000, 0x20000000, 0,
            //				Node.TYPE_BUFF1),

            new Node("park_lock_ctrl", 0x6C04, 0x67010000, 0x0200, 0, Node.TYPE_BUFF1),
            //功放设置
            new Node("speed_compensated_vol", 0xAD07, 0xA6020000, 0x0E0000, 0, Node.TYPE_BUFF1),

            new Node("surround_sound", 0xAD08, 0xA6020000, 0x010000, 0, Node.TYPE_BUFF1),

            new Node("reset_balance", 0xAD0A00, 0x00000000, 0x0000, 0, Node.TYPE_BUFF1),

            new Node("reset_all", 0xAD0B00, 0x00000000, 0x0000, 0, Node.TYPE_BUFF1),

...
public class GMSettingsRaiseFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private final static int[] CMDS = {0x3008200, 0x3008201, 0x3008202, 0x3008203, 0x3008204, 0x3008205, 0x3008206,
            ...
            0x3008300, 0x3008301, 0x3008302, 0x3008303, 0x3008304, 0x3008305, 0x3008306, 0x3008307, 0x3008308, 0x300830c, 0x3008317, 0x3008309, 0x300830b, 0x300830d, 0x300830e, 0x300830f, 0x3008316, 0x3008310, 0x3008311, 0x300835b, 0x3008313, 0x3008359, 0x3008358, 0x3008309, 0x3008318, 0x3008319, 0x300831b,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.gm_raise_settings);
    ...
    private void updateView(byte[] buf) {
        ...
        switch (buf[0]) {
            ...
            case 0x6:
                ...
                setPreference("auto_wipers", (int) ((buf[3] & 0x8) >> 3));
            case 0x7:
                if ((buf[2] & 0x1) != 0) {
                    ((SwitchPreference) findPreference("radarswitch")).setChecked(true);
                } else {
                    ((SwitchPreference) findPreference("radarswitch")).setChecked(false);
                }
            ...
            case 0xa:
                ...
                setPreference("folding", (int) ((buf[4] & 0x02) >> 1));
                setPreference("rtmirror", (int) ((buf[4] & 0x10) >> 4));
                setPreference("easyeeat", (int) ((buf[4] & 0x10) >> 4));
                setPreference("memory", (int) ((buf[4] & 0x20) >> 5));


                index = (int) ((buf[3] & 0xc0) >> 6);
                if (index == 3) {
                    index = 2;
                }
                setPreference("auto_collision", index);

                setPreference("status_notifi", (int) ((buf[3] & 0x20) >> 5));
                setPreference("window_control", (int) ((buf[4] & 0x4) >> 2));
                break;
            case 0xd:

                index = (int) ((buf[2] & 0x8f));
                ((ListPreference) findPreference("alarm_vol")).setValue(String.valueOf(index));
                ((ListPreference) findPreference("alarm_vol")).setSummary(((ListPreference) findPreference("alarm_vol")).getEntry());

...
public class GMSettingsSimpleFragment extends PreferenceFragmentCompat implements androidx.preference.Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Preference preference = findPreference("radarswitch");
        if (preference != null) preference.setOnPreferenceChangeListener(this);
        preference = findPreference("alarm_vol");
        if (preference != null) preference.setOnPreferenceChangeListener(this);
        preference = findPreference("restore");
    ...
    private void sendCanboxData(int cmd, int value) {
        if ((cmd & 0xff000000) == 0x3000000) {
            sendCanboxInfo(((cmd & 0xff00) >> 8), ((cmd & 0xff)), value);
        }
    }
    ...
    private void registerListener() {
        if (mReceiver == null) {
            ...
            if (getActivity() != null) this.getActivity().registerReceiver(mReceiver, iFilter);
        }
    }

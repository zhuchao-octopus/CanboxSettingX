...
public class HYSettingHiworldFragment extends PreferenceFragment implements
...
//车辆设置
			new Node("air_circulation_activated_according_to_external_dust_conditions", 0x6F01, 0x61010000, 0x80, 0,
					Node.TYPE_BUFF1),
			
			new Node("third_row_seat_back_fold_left_side", 0x6F02, 0x61010000, 0x8000, 0,
					Node.TYPE_BUFF1),
							
			new Node("third_row_seat_back_fold_right_side", 0x6F03, 0x61010000, 0x4000, 0,
					Node.TYPE_BUFF1),
							
			new Node("conv_tips_12", 0x6F04, 0x61010000, 0x2000, 0,
					Node.TYPE_BUFF1),
					
			new Node("seat_heating_or_ventilation", 0x6F05, 0x61010000, 0x1000, 0,
					Node.TYPE_BUFF1),
									
//			new Node("seat_status_switch", 0x6A0108, 0x62010000, 0x80, 0,
//					Node.TYPE_BUFF1),
					
			new Node("mute_status", 0xAD07, 0xA6020000, 0xFF0000, 0,
					Node.TYPE_BUFF1),			
		};

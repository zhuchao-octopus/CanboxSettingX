...
public class HaferH2Setting extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    private static final String TAG = "HaferH2Setting";

    private static final Node[] NODES = {

            new Node("dome_light_delay_time", 0x8200, 0x4, 0x0, 0x0), new Node("home_time", 0x8201, 0x4, 0x1, 0x0), new Node("power_saving_settings", 0x8202, 0x4, 0x2, 0x0),
            new Node("asl_set", 0x8203, 0x4, 0x3, 0x0), new Node("langauage5", 0x8204, 0x5, 0xf, 0x0),

...
public class HanTengSettingsRaiseFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    private static final String TAG = "HanTengSettingsRaiseFragment";
    private static final Node[] NODES = {new Node("ambient_light_brightness", 0xC801, 0x00000000, 0x00, 0, Node.TYPE_BUFF1),

            new Node("ambient_light_color", 0xC802, 0x00000000, 0x00, 0, Node.TYPE_BUFF1),};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.hanteng_raise_settings);

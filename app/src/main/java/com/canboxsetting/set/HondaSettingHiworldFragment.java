...
public class HondaSettingHiworldFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final Node[] NODES = {
            ...
            new Node("tripa_reset_time", 0x6F02, 0x69010000, 0x1800, 0, Node.TYPE_BUFF1),

            new Node("tripb_reset_time", 0x6F03, 0x69010000, 0x6000, 0, Node.TYPE_BUFF1),
            //
            //////灯光设置
            ...
            //
            //////车锁设置
            new Node("keyless_unlock_answer_back", 0x6D01, 0x65010000, 0x0100, 0, Node.TYPE_BUFF1),

            new Node("security_relock_timer", 0x6D02, 0x65010000, 0x0600, 0, Node.TYPE_BUFF1),
            ...
            new Node("remote_start_system", 0x6B01, 0x66010000, 0x0100, 0, Node.TYPE_BUFF1),

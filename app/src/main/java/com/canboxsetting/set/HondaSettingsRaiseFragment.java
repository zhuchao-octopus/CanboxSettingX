...
public class HondaSettingsRaiseFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final Node[] NODES = {
            ...
            new Node("driver_attention_monitor", 0xC624, 0x32000000, 0x0660, 0x0, Node.TYPE_BUFF1_INDEX), new Node("the_handle_electrically", 0xC626, 0x32000000, 0x0680, 0x0, Node.TYPE_BUFF1_INDEX),
            new Node("remote_control_open_condition", 0xC625, 0x32000000, 0x0610, 0x0, Node.TYPE_BUFF1_INDEX),

            new Node("reset_info", 0xC60e00),


            new Node("trunk_lid_induction_opening_closing_function", 0xC646, 0x32000000, 0x0a80, 0x0, Node.TYPE_BUFF1_INDEX),
            new Node("view_mirror_automatically_folded", 0xC647, 0x32000000, 0x0a40, 0x0, Node.TYPE_BUFF1_INDEX),

...
public class HondaSettingsRaiseFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final Node[] NODES = {
            ...
            new Node("driver_attention_monitor", 0xC624, 0x32000000, 0x0660, 0x0, Node.TYPE_BUFF1_INDEX), new Node("the_handle_electrically", 0xC626, 0x32000000, 0x0680, 0x0, Node.TYPE_BUFF1_INDEX), new Node("remote_control_open_condition", 0xC625, 0x32000000, 0x0610, 0x0, Node.TYPE_BUFF1_INDEX),

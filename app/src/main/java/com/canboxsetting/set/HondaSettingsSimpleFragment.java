...
public class HondaSettingsSimpleFragment extends PreferenceFragment implements
	...
	private static final Node[] NODES = {
			...
			new Node("driver_attention_monitor", 0xC624, 0x32000000, 0x090c,
					0x0, Node.TYPE_BUFF1_INDEX),
			new Node("the_handle_electrically", 0xC626, 0x32000000, 0x0902,
					0x0, Node.TYPE_BUFF1_INDEX),
			new Node("remote_control_open_condition", 0xC625, 0x32000000,
					0x0901, 0x0, Node.TYPE_BUFF1_INDEX),

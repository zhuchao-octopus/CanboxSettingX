...
public class JeepSettingsSimpleFragment extends PreferenceFragment implements
...
//		} else 
	...
	private void setTempUnit(String value) {
		...
		SystemConfig.setProperty(getActivity(), SystemConfig.CANBOX_TEMP_UNIT,
				value);
	...
	private void updateTempUnit() {
		...
		String value = SystemConfig.getProperty(getActivity(),
				SystemConfig.CANBOX_TEMP_UNIT);

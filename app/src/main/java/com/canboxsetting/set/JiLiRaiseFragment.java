...
public class JiLiRaiseFragment extends PreferenceFragment implements
	...
	private static final NodePreference[] NODES_X1= {
		new NodePreference("speed_lock1", 0x8000, 0x5000, 0x80, 0),
		new NodePreference("stop_unlock", 0x8001, 0x5000, 0x40, 0),		
		new NodePreference("door_open_turn_signal_flashes", 0x8002, 0x5000, 0x40, 0),
		new NodePreference("remote_lock_feedback", 0x8003, 0x5000, 0x10, 0),
	...
	private static final NodePreference[] NODES_X6= {
		//
		new NodePreference("intelligent_bend_light", 0x8005, 0x5001, 0x80, 0),
		new NodePreference("view_mirror_automatically_folded", 0x8014, 0x5001, 0x40, 0),
		//
	...
	private static final NodePreference[] NODES_18BOYUE= {
		...
		new NodePreference("remote_lock_feedback", 0x8007, 0x5002, 0x40, 0),
		new NodePreference("automatically_close_the_window", 0x8008, 0x5002, 0x20, 0),
		new NodePreference("close_the_skylight_shade", 0x8009, 0x5002, 0x10, 0),
		new NodePreference("daytime_driving_lights", 0x800a, 0x5002, 0x8, 0),
	...
	private static final NodePreference[] NODES_1819DIHAO= {
		new NodePreference("speed_lock1", 0x8000, 0x5006, 0x80, 0),
		new NodePreference("stop_unlock", 0x8001, 0x5006, 0x40, 0),
	...
	private static final NodePreference[] NODES = {
		new NodePreference("speed_lock1", 0x8000, 0x5000, 0x80, 0),
		new NodePreference("stop_unlock", 0x8001, 0x5000, 0x40, 0),		
		new NodePreference("door_open_turn_signal_flashes", 0x8002, 0x5000, 0x20, 0),
		new NodePreference("remote_lock_feedback", 0x8003, 0x5000, 0x10, 0),
		new NodePreference("automatically_turns_off_position_light_after_locking", 0x8004, 0x5000, 0x8, 0),
		...
		//
		new NodePreference("fort_tips", 0x8011, 0x5003, 0x80, 0,
					R.array.fortification_prompt_entries, R.array.three_values),

		new NodePreference("trunk_auto_unlock_distance", 0x8023, 0x5003,
					0x20, 0, R.array.trunk_auto_unlock_distance_entries,
					R.array.three_values),
		
		new NodePreference("trunk_auto_on", 0x8022, 0x5003, 0x10, 0),
		new NodePreference("keyless_unlocking_of_the_trunk", 0x8024, 0x5003, 0x8, 0),
		new NodePreference("any_door_open_lock_lock_alarm_setting", 0x801e, 0x5003, 0x4, 0),
		new NodePreference("near_unlocked_configuration", 0x801f, 0x5003, 0x2, 0),
		new NodePreference("leave_locked_configuration", 0x8020, 0x5003, 0x1, 0),
			...
			new NodePreference("language", 0x801a,
					0x2700, 0x01, 0,
					R.array.chery_language_status_entries,
					R.array.three_values),
			new NodePreference("showdistancecontrol", 0x8019,
					0x5005, 0xc, 0,
					R.array.alarm_distance_entries,
					R.array.three_values),
			new NodePreference("low_speed_warning_tone", 0x801b,
					0x4f00, 0xc, 0,
					R.array.alarm_sensitivity_entries,
					R.array.three_values),
		...
		for (int i = 0; i < NODES.length; ++i) {
			if (NODES[i].mKey.equals(key)) {
				if (preference instanceof ListPreference) {
					...
					sendCanboxInfo((NODES[i].mCmd & 0xff00) >> 8,
							NODES[i].mCmd & 0xff, ((Boolean) newValue) ? 0x1
									: 0x0);

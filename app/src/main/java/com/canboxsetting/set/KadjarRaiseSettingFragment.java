...
public class KadjarRaiseSettingFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final Node[] NODES = {
            ...
            new Node("front_parking", 0x8301, 0x7100, 0x2), new Node("back_parking", 0x8302, 0x7100, 0x1),

            new Node("air_loop", 0x8303, 0x7101, 0x8), new Node("car_start", 0x8305, 0x7101, 0x4), new Node("ion_generator", 0x8304, 0x7101, 0x3),


            new Node("indicator", 0x830c, 0x7102, 0x80), new Node("wiper_back", 0x830b, 0x7102, 0x40), new Node("auto_cabin", 0x830a, 0x7102, 0x20), new Node("external_welcome", 0x8309, 0x7102, 0x10),


            new Node("door_aut", 0x8306, 0x7102, 0x4), new Node("prompt_volume", 0x8307, 0x7102, 0x3),


            new Node("user_reset", 0x838002, 0, 0),

            new Node("langauage", 0x830d, 0x7103, 0xff), new Node("inside_light", 0x8308, 0x7102, 0x8),
        ...
        for (int i = 0; i < NODES.length; ++i) {
            if (NODES[i].mKey.equals(key)) {
                if (preference instanceof ListPreference) {
                    ...
                    if ("instrument_color".equals(key) || "langauage".equals(key)) {

...
public class LandRoverHaoZhengSettingsFragment extends PreferenceFragment
	...
	new Node("over_speed", 0, 0, 0, 0x0),
			new Node("speed_alarms", 0, 0, 0, 0x0),
			new Node("oil_unit", 0, 0, 0, 0x0),
			new Node("instrument_style", 0, 0, 0, 0x0),
			new Node("reset1", 0, 0, 0, 0x0), new Node("reset2", 0, 0, 0, 0x0),
			new Node("reset3", 0, 0, 0, 0x0),
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		p.setTitle(getString(R.string.reset) + " "
				+ getString(R.string.fulecons) + "1");
		p = findPreference("reset2");
		p.setTitle(getString(R.string.reset) + " "
				+ getString(R.string.fulecons) + "2");

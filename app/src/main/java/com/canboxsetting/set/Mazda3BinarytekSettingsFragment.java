...
public class Mazda3BinarytekSettingsFragment extends PreferenceFragment
	...
	new Node("default_all", 0x8418, 0x0, 0x0, 0x0),
			new Node("alarm_distance2", 0x841d, 0x7, 0x6, 0x0),
			...
			new Node("auto_light_open", 0x840d, 0x3, 0x7, 0x0),
			new Node("car_light_off", 0x840b, 0x3, 0xc0, 0x0),

			new Node("adaptive", 0x840a, 0x2, 0x80, 0x0),
			new Node("turn_volume", 0x8407, 0x1, 0x10, 0x0),
			new Node("three_signal", 0x8406, 0x1, 0x20, 0x0),

			new Node("automatic_latch", 0x8405, 0x1, 0x40, 0x0),
			new Node("lock_mode", 0x8404, 0x1, 0x80, 0x0),
			...
			new Node("alarm_volume", 0x841b, 0x7, 0x30, 0x0),
			new Node("alarm_distance", 0x841a, 0x7, 0x40, 0x0),
			new Node("mode", 0x8419, 0x7, 0x80, 0x0),

			new Node("reset_avg", 0x8417, 0x2, 0x4, 0x0),
			new Node("sync_avg", 0x8416, 0x2, 0x4, 0x0),
			...
			new Node("height", 0x840e, 0x4, 0xff, 0x0),
			new Node("brightness_control", 0x8410, 0x5, 0xff, 0x0),
			new Node("height2", 0x8413, 0x6, 0xff, 0x0),
			
			//settings 2 v1.08

			new Node("blind_area_monitoring", 0x841e, 0x0, 0x80, 0x1),
			new Node("mazda3_binarytek_settings2_01", 0x8430, 0x0, 0x02, 0x1),
			new Node("mazda3_binarytek_settings2_02", 0x8431, 0x0, 0x01, 0x1),
			

			new Node("mazda3_binarytek_settings2_03", 0x8432, 0x1, 0xc0, 0x1),
			new Node("mazda3_binarytek_settings2_04", 0x8433, 0x1, 0x20, 0x1),
			new Node("mazda3_binarytek_settings2_05", 0x8434, 0x1, 0x18, 0x1),
			new Node("mazda3_binarytek_settings2_06", 0x8435, 0x1, 0x06, 0x1),
			

			new Node("mazda3_binarytek_settings2_07", 0x8440, 0x2, 0x80, 0x1),
			new Node("mazda3_binarytek_settings2_08", 0x8441, 0x2, 0x60, 0x1),
			new Node("mazda3_binarytek_settings2_09", 0x8442, 0x2, 0x18, 0x1),
			

			new Node("mazda3_binarytek_settings2_0a", 0x8450, 0x2, 0x04, 0x1),
			new Node("mazda3_binarytek_settings2_0b", 0x8451, 0x2, 0x02, 0x1),
			

			new Node("mazda3_binarytek_settings2_10", 0x8420, 0x0, 0x40, 0x1),
			new Node("mazda3_binarytek_settings2_11", 0x8421, 0x0, 0x38, 0x1),

...
public class Mazda3SettingsSimpleFragment extends PreferenceFragment implements
		Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
	private static final String TAG = "Mazda3BinarytekFragment";

	private static final Node[] NODES = {

	new Node("outo_lock_mode", 0xC601, 0x0, 0xf0, 0x0),
			new Node("lock_beep", 0xC602, 0x0, 0x0f, 0x0),
			new Node("security", 0xC603, 0x1, 0xf0, 0x0),
			new Node("lock_mode", 0xC604, 0x1, 0x0f, 0x0),
			new Node("car_lock", 0xC605, 0x2, 0x80, 0x0),
			new Node("three_signal", 0xC611, 0x2, 0x20, 0x0),
			new Node("turn_volume", 0xC612, 0x2, 0x0f, 0x0),
			new Node("auto_lights_off2", 0xC621, 0x3, 0xf0, 0x0),
			new Node("auto_lights_off3", 0xC622, 0x3, 0x0f, 0x0),

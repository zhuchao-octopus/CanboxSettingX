...
public class MazdaCX5SettingsSimpleFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final Node[] NODES = {
            ...
            new Node("autodoorlockmode", 0xc600, 0x32, 0xe0, 0x0),

            new Node("unlockmode", 0xc601, 0x32, 0x10, 0x0), new Node("autorelocktime", 0xc602, 0x32, 0x0c, 0x0), new Node("lockbeepvol", 0xc603, 0x32, 0x03, 0x0),


            new Node("walkalwaylock", 0xc604, 0x32, 0x8000, 0x0), new Node("opendoortime", 0xc605, 0x32, 0x6000, 0x0), new Node("closedoortime", 0xc606, 0x32, 0x1800, 0x0),

            new Node("flashturnsigal", 0xc607, 0x32, 0xc00000, 0x0),

            new Node("headlightofftime", 0xc608, 0x32, 0x300, 0x0),

            new Node("autoheadlighton", 0xc609, 0x32, 0x300000, 0x0), new Node("wipers", 0xc60a, 0x32, 0x80000, 0x0),
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.mazda_cx5_simple_settings);

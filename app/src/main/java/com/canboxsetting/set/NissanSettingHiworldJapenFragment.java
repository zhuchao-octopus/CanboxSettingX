...
public class NissanSettingHiworldJapenFragment extends PreferenceFragment implements
...
////功放设置
		new Node("speed_linkage_volume", 0xAD07, 0xA6020000, 0x070000, 0,
				Node.TYPE_BUFF1),
		
		new Node("surround_volume", 0xAD08, 0xA6020000, 0xFF000000, 0,
				Node.TYPE_BUFF1),
						
		new Node("bose_center_point", 0xAD09, 0xA6020000, 0x080000, 0,
				Node.TYPE_BUFF1),
		
		new Node("driver_seat_sound_field", 0xAD0A, 0xA6020000, 0x100000, 0,
				Node.TYPE_BUFF1),					
		};

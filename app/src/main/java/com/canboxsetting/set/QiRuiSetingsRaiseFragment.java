...
public class QiRuiSetingsRaiseFragment extends PreferenceFragment implements
	...
	private static final NodePreference[] NODES = {
			...
			new NodePreference("fortification_prompt", 0xc6, 0x40, 0x1, 0,
					R.array.chery_notification_entries, R.array.three_values),
		...
		new NodePreference("over_speed", 0xc6, 0x40, 0x9, 0,
				R.array.over_speed, R.array.thirty_values),
				

				new NodePreference("backlighting", 0xc6, 0x40, 0xa, 0,
						R.array.dashboard_brightness_value, R.array.dashboard_brightness_value),
		...
		new NodePreference("accompany_me_home", 0xc6, 0x40, 0x14, 0,
				R.array.qirui1, R.array.eleven_values),

				new NodePreference("strobe_flashing_light", 0xc6, 0x40, 0x15, 0,
						R.array.turn_signal_oushange, R.array.eleven_values),
				
		new NodePreference("str_welcome", 0xc6, 0x40, 0x16, 0),
		
		
		new NodePreference("electronic_power_mode_selection", 0xc6, 0x40, 0x17, 0,
				R.array.electronic_power_mode_selection_entries, R.array.eleven_values),
				
		new NodePreference("blower_opens_ahead_of_schedule", 0xc6, 0x40, 0x19, 0),
		

		new NodePreference("ambient_light_brightness", 0xc6, 0x40, 0x20, 0,
				R.array.chery_ambient_light_brightness_entries, R.array.eleven_values),
		...
		new NodePreference("adaptive_cruise_system", 0xc6, 0x40, 0x27, 0,
				R.array.adaptive_cruise_system_entries, R.array.eleven_values),
		...
		new NodePreference("language", 0xc6, 0x40, 0x0, 0,

...
public class RAMFiatSettingSimpleFragment extends PreferenceFragment implements
	...
	private static final Node[] NODES = {
		...
		new Node("unit", 0xc601, 0x40010000, 0x01),
		new Node("oil_unit", 0xc605, 0x40010000, 0x06),
		new Node("mileage_unit", 0xc603, 0x40010000, 0x08),
		new Node("temp", 0xc604, 0x40010000, 0x10),

		

		new Node("fuel_saver", 0xc602, 0x40020000, 0x01),
		new Node("dis_trip_b", 0xc606, 0x40030000, 0x01),
		new Node("hill_start", 0xc610, 0x40100000, 0x01),
		
		

		new Node("lights_wipers", 0xc622, 0x40200000, 0x80),
		new Node("flash_lights", 0xc623, 0x40200000, 0x8000),
		new Node("headlight_off", 0xc620, 0x40200000, 0x7f),
		new Node("illuminated", 0xc621, 0x40200000, 0x7f00),
		new Node("daytime", 0xc624, 0x40200000, 0x10000),
		

		new Node("auto_door", 0xc630, 0x40300000, 0x1),
		new Node("auto_unlock_on", 0xc631, 0x40300000, 0x2),
		new Node("door_flash_lights", 0xc632, 0x40300000, 0x4),
		new Node("horn_lock", 0xc633, 0x40300000, 0x8),
		new Node("remote_door", 0xc634, 0x40300000, 0x100),
		new Node("autoclose", 0xc635, 0x40300000, 0x200),


		new Node("headlight_off1", 0xc640, 0x40400000, 0xff),
		new Node("engine_power", 0xc641, 0x40400000, 0xff00),
		

		new Node("show_time", 0xc670, 0x40700000, 0x1),
		new Node("sync_time", 0xc671, 0x40700000, 0x2),
		

		new Node("trailer_m", 0xc650, 0x40500000, 0xf0),
		new Node("trailer_type", 0xc651, 0x40500000, 0xf),
	};

	private final static int[] INIT_CMDS = {
	0x4000, 0x4001, 0x4002, 0x4003, 0x4010, 0x4020, 0x4030, 0x4040, 0x4050,
			0x4070,

...
public class Set100 extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    private static final String TAG = "Set275";

    private static final NodePreference[] NODES = {

            new NodePreference("gs4_energy_recovery", 0x9701, 0x2901, 0xff, 0, R.array.four_values, R.array.four_values),


            new NodePreference("head_up_display", 0x9702, 0x2902, 0xff, 0), new NodePreference("vps_switch", 0x9703, 0x2903, 0xff, 0),

            new NodePreference("power_level", 0x9704, 0x2904, 0xff, 0, R.array.four_values, R.array.four_values),


            new NodePreference("power_lock", 0x9705, 0x2905, 0xff, 0),

            new NodePreference("headlight_off", 0x9707, 0x2907, 0xff, 0, R.array.enheadlights_off, R.array.four_values),

            new NodePreference("car_in_light", 0x9708, 0x2908, 0xff, 0, R.array.dongfeng_atmosphere_lamp_entries, R.array.three_values),

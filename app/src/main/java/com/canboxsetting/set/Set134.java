...
public class Set134 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("langauage5", 0x9b01, 0x9600, 0x03, 0, R.array.chery_language_status_entries, R.array.twelve_values),

            new NodePreference("str_auto_compressor_status", 0x9b02, 0x9601, 0x80, 0),

            new NodePreference("str_auto_cycle_mode", 0x9b03, 0x9601, 0x40, 0, R.array.automatic_air_conditioning_mode_entries, R.array.twelve_values),

            new NodePreference("str_ac_comfort_setting", 0x9b04, 0x9601, 0x30, 0, R.array.trumpche_speed_level_entries, R.array.twelve_values),

            new NodePreference("auto_heat", 0x9b05, 0x9602, 0x80, 0), new NodePreference("fu_auto_heat", 0x9b06, 0x9602, 0x40, 0),


            new NodePreference("over_speed", 0x9b07, 0x9603, 0xff, 0, 0, 200, 10),


            new NodePreference("meter_vol", 0x9b08, 0x9604, 0xff, 0, R.array.parksense_volume_entries, R.array.twelve_values),

            new NodePreference("str_power_on_time", 0x9b09, 0x9605, 0xff, 0, 0, 30, 1), new NodePreference("str_start_time", 0x9b0a, 0x9606, 0xff, 0, 0, 30, 1),

            new NodePreference("str_turn_mode", 0x9b0b, 0x9607, 0xff, 0, R.array.trumpche_turn_mode_entries, R.array.twelve_values),
            ...
            new NodePreference("lamp_steering", 0x9b13, 0x9609, 0x20, 0), new NodePreference("running_lights", 0x9b14, 0x9609, 0x10, 0),

...
public class Set147 extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("ambient_light_color", 0x6f01, 0x6100, 0xe0, 0, R.array.atmosphere_light_color_entries2, R.array.eight_values),
            ...
            new NodePreference("adjust_the_prompt_volume", 0x6f14, 0x6106, 0xc, 0, R.array.new_tourui_three_values, R.array.three_values),

            new NodePreference("external_welcome", 0x6f15, 0x6106, 0x2, 0), new NodePreference("auto_lights_off", 0x6f16, 0x6106, 0x1, 0),
            //
            new NodePreference("driving_style_tips", 0x6f17, 0x6107, 0x80, 0),

            new NodePreference("dashboard_brightness", 0x6f18, 0x6107, 0x1f, 0, R.array.instrument_light_value, R.array.thirty_values),

            new NodePreference("reduction_of_fetal_pressure", 0x6f19, 0x6101, 0x80, 0), new NodePreference("renual00", 0x6f1a, 0x6108, 0x80, 0),

            new NodePreference("parking_sound_type", 0x6f1b, 0x6108, 0x60, 0, R.array.parking_sound_type_entries, R.array.three_values),
            //
            ...
            new NodePreference("reset_main_info", 0x6f3c, 0x6200, 0x0, 0), new NodePreference("str_daytime_running_lamp", 0x6f3d, 0x6204, 0x80, 0),
            //
            //
            new NodePreference("str_go_home", 0x6f3e, 0x6204, 0x70, 0, R.array.jac_time, R.array.five_values),

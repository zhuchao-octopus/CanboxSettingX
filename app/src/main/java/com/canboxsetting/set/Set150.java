...
public class Set150 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("headlight_off", 0x0030, 0x3600, 0x30, 0, R.array.enheadlights_off, R.array.twelve_values), new NodePreference("unlock_open_lamp", 0x000c, 0x3600, 0x0c, 0, R.array.enheadlights_off, R.array.twelve_values),
            ...
            new NodePreference("zhonghua_xx", 0x0180, 0x3601, 0x80, 0), new NodePreference("unlock_driving", 0x0140, 0x3601, 0x40, 0),


            new NodePreference("first_press_of_key_unlocks", 0x0120, 0x3601, 0x20, 0, R.array.remote_unlock_entries, R.array.twelve_values),

            new NodePreference("keyless_entry", 0x0110, 0x3601, 0x10, 0), new NodePreference("outseat_heating", 0x0108, 0x3601, 0x08, 0),

            new NodePreference("engine_power", 0x0106, 0x3601, 0x06, 0, R.array.enpower_off, R.array.twelve_values), new NodePreference("language", 0x02f0, 0x3602, 0xf0, 0, R.array.kuwei_language_entries, R.array.twelve_values), new NodePreference("unit_setting", 0x020f, 0x3602, 0x0f, 0, R.array.kuwei_metric_entries, R.array.twelve_values),

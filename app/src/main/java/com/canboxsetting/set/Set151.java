...
public class Set151 extends PreferenceFragment implements
	...
	new NodePreference("daylight", 0xc801, 0x4100, 0xff, 0),
	 new NodePreference("myhome", 0xc802, 0x4101, 0xff, 0,
	 R.array.closedoortime_entries, R.array.four_values),
	
	 new NodePreference("indoor_lamp_delay", 0xc803, 0x4102, 0xff, 0,
	 R.array.indoor_lamp_length_entries, R.array.three_values),

		new NodePreference("smart_key_lock_fuction", 0xc804, 0x4103, 0xff, 0),
		new NodePreference("str_speed_lock", 0xc805, 0x4104, 0xff, 0),
		new NodePreference("str_auto_unlock", 0xc806, 0x4105, 0xff, 0),

		 new NodePreference("post_defrosting_time", 0xc807, 0x4106, 0xff, 0,
		 R.array.post_defrosting_time_key_entries, R.array.two_values),

			new NodePreference("automatic_screen_wipe", 0xc808, 0x4107, 0xff, 0),
			new NodePreference("esp_system", 0xc809, 0x4108, 0xff, 0),
			new NodePreference("str_front_wiper_maintain", 0xc80a, 0x4109, 0xff, 0),
			new NodePreference("remote_car_control", 0xc80b, 0x410a, 0xff, 0),

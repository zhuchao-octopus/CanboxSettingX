...
public class Set154 extends PreferenceFragment implements
	...
	private static final NodePreference[] NODES = {
		 ...
		 new NodePreference("ambient_light_color", 0x9761, 0x07020f, 0x0, 0,
				 R.array.atmosphere_raise_light_color_entries, R.array.eninstrument_style3_value),
		...
		new NodePreference("drive_adjustment_high", 0xc001, 0x4001ff, 0, 0, 10), 
		new NodePreference("drive_adjustment_medium", 0xc002, 0x4002ff, 0, 0, 10), 
		new NodePreference("drive_adjustment_low", 0xc003, 0x4003ff, 0, 0, 10), 


		new NodePreference("passenger_adjustment_high", 0xc004, 0x4004ff, 0, 0, 10), 
		new NodePreference("passenger_adjustment_medium", 0xc005, 0x4005ff, 0, 0, 10), 
		new NodePreference("passenger_adjustment_low", 0xc006, 0x4006ff, 0, 0, 10), 
		
		
		 new NodePreference("drive_message_backrest", 0xc007, 0x40070c, 0x0, 0,
		 R.array.seat_heat_values, R.array.three_values),
		 new NodePreference("drive_message_cushion", 0xc008, 0x400703, 0x0, 0,
				 R.array.seat_heat_values, R.array.three_values),
				 
				 new NodePreference("passenger_message_backrest", 0xc009, 0x40080c, 0x0, 0,
						 R.array.seat_heat_values, R.array.three_values),
						 new NodePreference("passenger_message_cushion", 0xc00a, 0x400803, 0x0, 0,
								 R.array.seat_heat_values, R.array.three_values),
		};

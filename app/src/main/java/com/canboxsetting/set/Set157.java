...
public class Set157 extends PreferenceFragment implements
	...
	private static final NodePreference[] NODES = {
		...
		new NodePreference("car_light_auto", 0x9702, 0x30, 0x80, 0),
		
		
	new NodePreference("setting_auto_light_sensitivity", 0x9703, 0x30, 0x60, 0, R.array.duke_setting_auto_light_sensitivity, R.array.brightness_control_value),

		
	
	new NodePreference("smart_key_lock_fuction", 0x9707, 0x30, 0x08, 0),
	
	new NodePreference("automatic_lighting_time_setting", 0x9704, 0x30, 0xf00, 0, R.array.automatic_lighting_time_setting, R.array.brightness_control_value),
	
	
	new NodePreference("vehicle_speed_interlocking_intermittent_wiper", 0x9705, 0x30, 0x10, 0),
	
	
	
	
//	new NodePreference("bose_center_point", 0xa30f, 0x13, 0x0680, 1),
	
//	new NodePreference("driver_seat_sound_field", 0x8329, 0x93, 10, 1),
	
//new NodePreference("speed_linkage_volume", 0xa328, 0x13, 0x0607, 1, 5),
	
//	new NodePreference("surround_volume", 0x8323, 0x93, 9, 1, 11),

	};

	private final static int[] INIT_CMDS = { 0x30 };
...
//		((MyPreferenceEdit) findPreference("speed_linkage_volume"))
//				.setCallback(mButtonCallBack);
//		((MyPreferenceEdit) findPreference("surround_volume"))
//				.setCallback(mButtonCallBack);
	}
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (!mPaused) {
				byte[] buf = new byte[] { (byte) 0xf1, 0x1,
						(byte) (msg.what & 0xff) };

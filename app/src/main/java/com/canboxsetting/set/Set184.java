...
public class Set184 extends PreferenceFragment
	...
	private static final Node[] NODES = {
		...
		new Node("top_light_delayed_time", 0x8304, 0x3100, 0xf0, 3),
		new Node("go_home_delayed_time", 0x8305, 0x3100, 0xf, 3),
		new Node("economize_on_electricity", 0x8306, 0x3101, 0xf0, 3),
		new Node("rain_light_sensor_settings", 0x8307, 0x3101, 0x8, 1),
		new Node("headlamp_brightness_setting", 0x8308, 0x3101, 0x4, 1),
		new Node("automatic_folding_of_rearview_mirror_key", 0x8309, 0x3101, 0x2),
		
		
		new Node("trailer_settings", 0x8319, 0x3103, 0x10),
		new Node("headlight_mode_key", 0x830c, 0x3101, 0x1),
		new Node("seat_memory_key", 0x830d, 0x3102, 0x80),
		new Node("parking_setting_key", 0x830f, 0x3102, 0x40),
		new Node("antitheft_prevention_key", 0x830e, 0x3102, 0x30),
		new Node("gate_setting_key", 0x8310, 0x3102, 0x8),
		new Node("electric_sidestepping_system_key", 0x8311, 0x3102, 0x4),
		new Node("roof_mode_key", 0x8312, 0x3102, 0x2),
		new Node("full_terrain_key", 0x8313, 0x3102, 0x1),
		new Node("precollision_warning_system_key", 0x8317, 0x3103, 0x02),
		new Node("automatic_emergency_braking_system_key", 0x8318, 0x3103, 0x01),
		new Node("intelligent_start_and_stop_key", 0x830b, 0x3103, 0x20),

		
		new Node("fatigue_driving_warning", 0x833c, 0x3105, 0x10),
		new Node("early_warning_sensitivity", 0x8332, 0x3104, 0x30),
		
		

		new Node("driving_buttocks_massage", 0x8426, 0x2308, 0xf0),
		new Node("copilot_buttocks_massage", 0x8427, 0x2308, 0x0f),


		new Node("driving_waist_massage", 0x8428, 0x2309, 0xf0),
		new Node("side_drive_massage", 0x8429, 0x2309, 0x0f),

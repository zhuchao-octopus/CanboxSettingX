...
public class Set193 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("the_15KMH_automatic_latch", 0x6c02, 0x6702, 0x2, 0), new NodePreference("str_outside_rearview", 0x6c03, 0x6703, 0x1, 0),

            new NodePreference("go_home_lighting_delay", 0x6c04, 0x6702, 0x1c, 0, R.array.byd_go_home, R.array.eight_values), new NodePreference("leave_home_lighting_delay", 0x6c05, 0x6702, 0xe0, 0, R.array.byd_go_home, R.array.eight_values),


            new NodePreference("outside_the_Logo_lamp_of_the_rear_view_mirror_is_lit", 0x6c06, 0x6703, 0x2, 0), new NodePreference("automatic_dome_lamp_lighting_time", 0x6c07, 0x6703, 0xc, 0, R.array.beiqi003_01, R.array.four_values),


            new NodePreference("remote_lift_window", 0x6c08, 0x6703, 0x10, 0), new NodePreference("remote_control_window_drop", 0x6c09, 0x6703, 0x20, 0), new NodePreference("the_headlights_flashing_when_disarming", 0x6c0a, 0x6703, 0x40, 0), new NodePreference("open_the_door_to_stop_the_wiper", 0x6c0b, 0x6703, 0x80, 0), new NodePreference("to_automatically_open_the_haze_lamp", 0x6c0c, 0x6704, 0x1, 0), new NodePreference("driver_seat_auto_return", 0x6c0d, 0x6704, 0x2, 0),
            ...
            new NodePreference("high_speed_reminder", 0x6d02, 0x6801, 0x4, 1), new NodePreference("speed_limit_in_winter", 0x6d03, 0x6801, 0x8, 1), new NodePreference("BSD_warning_tone_opens", 0x6d04, 0x6801, 0x10, 1), new NodePreference("LDW_warning_tone_opens", 0x6d05, 0x6801, 0x20, 1),


            //group3
            new NodePreference("auto_inner_loop", 0x6b01, 0x6601, 0x1, 2), new NodePreference("AC_automatic_mode", 0x6b02, 0x6601, 0x2, 2), new NodePreference("automatic_air_volume", 0x6b03, 0x6601, 0x4, 2), new NodePreference("air_conditioning_high_temperature_inner_loop", 0x6b04, 0x6601, 0x8, 2), new NodePreference("automatic_drop_wind_speed", 0x6b05, 0x6601, 0x70, 2, R.array.enwind_speed, R.array.eight_values),

...
public class Set201 extends PreferenceFragment implements
	...
	new NodePreference("myhome", 0xc601, 0x3200, 0xf, 0,
			R.array.guanzhi_1, R.array.guanzhi_1),
	
						
						new NodePreference("welcome_light", 0xc602, 0x3200, 0x40, 0),	

						new NodePreference("backlighting", 0xc603, 0x3201, 0xf0, 0,
								R.array.eleven_values, R.array.eleven_values),
		
			new NodePreference("language", 0xc604, 0x3201, 0xf, 0,
						R.array.chery_language_status_entries, R.array.two_values),

						new NodePreference("distance_unit", 0xc605, 0x3202, 0xc0, 0,
								R.array.mileage_unit_t, R.array.two_values),
								
											
								new NodePreference("temp", 0xc607, 0x3202, 0x10, 0,
										R.array.entemp, R.array.two_values),								
					
								new NodePreference("gac_oil_consumption", 0xc608, 0x3202, 0xc, 0,
										R.array.enoil_unit, R.array.three_values),	

...
public class Set204 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    private static final String TAG = "HYSettingsRaiseFragment";

    private static final NodePreference[] NODES = {

            new NodePreference("electric_sliding_door_function", 0x8301, 0x600, 0x01, 0), new NodePreference("byd_remote_control_window", 0x8302, 0x600, 0x2, 0),

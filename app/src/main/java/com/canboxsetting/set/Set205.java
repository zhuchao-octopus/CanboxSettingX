...
public class Set205 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    private static final String TAG = "HYSettingsRaiseFragment";

    private static final NodePreference[] NODES = {


            new NodePreference("left_and_right_mirror_front_lamp_control", 0x78, 0xf000, 0xf, 0, R.array.left_and_right_mirror_front_lamp_control_entries, R.array.radarrange_entries1),
        ...
        for (int i = 0; i < NODES.length; ++i) {
            if (NODES[i].mKey.equals(key)) {
                if (preference instanceof ListPreference) {
                    ...
                    byte[] buf = new byte[]{(byte) 0x78, 0x8, (byte) Integer.parseInt((String) newValue), 0, 0, 0, 0, 0, 0, 0};

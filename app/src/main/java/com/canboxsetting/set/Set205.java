...
public class Set205 extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
        ...
        for (int i = 0; i < NODES.length; ++i) {
            if (NODES[i].mKey.equals(key)) {
                if (preference instanceof ListPreference) {
                    ...
                    byte[] buf = new byte[]{
                            (byte) 0x78, 0x8, (byte) Integer.parseInt((String) newValue), 0, 0, 0, 0, 0, 0, 0
                    };

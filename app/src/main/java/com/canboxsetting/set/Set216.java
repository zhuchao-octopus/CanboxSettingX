...
public class Set216 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("side_angle_radar_sensitivity", 0x6f02, 0x6100, 0x70, 0, R.array.four_high_values, R.array.four_high_values),

            new NodePreference("center_radar_sensitivity", 0x6f03, 0x6100, 0xe, 0, R.array.four_high_values, R.array.four_high_values),


            new NodePreference("car_light_auto", 0x6f04, 0x6101, 0x80, 0),

            new NodePreference("autolight", 0x6f05, 0x6101, 0x70, 0, R.array.four_high_values, R.array.four_high_values),

            new NodePreference("timeswitchlight", 0x6f06, 0x6101, 0xe, 0, R.array.automatic_lighting_time_setting, R.array.eight_values),
            ...
            new NodePreference("radarvol", 0x6f1f, 0x6105, 0x0c, 0, R.array.three_high_values, R.array.three_high_values),
            ...
            new NodePreference("speed_compensated_vol", 0xad07, 0xa606, 0x7, 1, 0, 5, 1), new NodePreference("surround_volume", 0xad08, 0xa607, 0xff, 1, -5, 5, 1),


            new NodePreference("bose_center_point", 0xad09, 0xa606, 0x8, 1), new NodePreference("driver_seat_sound_field", 0xad0a, 0xa606, 0x10, 1),

            //group3
            new NodePreference("outside_odor_sensor", 0x3b03, 0x3505, 0xf0, 2, R.array.five_high_values, R.array.five_high_values),

            new NodePreference("adjusting_the_automatic_defrost", 0x3b0b, 0x3505, 0x0f, 2, R.array.five_high_values, R.array.five_high_values),


            new NodePreference("natural_wind", 0x3b15, 0x3506, 0x80, 2), new NodePreference("wind_intensity", 0x3b16, 0x3506, 0x40, 2), new NodePreference("aromatic", 0x3b17, 0x3506, 0x20, 2),
        ...
        for (int i = 0; i < NODES.length; ++i) {
            if (NODES[i].mKey.equals(key)) {
                if (preference instanceof ListPreference) {
                    ...
                    try {
                        cur = Integer.parseInt(preference.getSummary().toString());
                    } catch (Exception e) {

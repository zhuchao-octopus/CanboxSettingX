...
public class Set225 extends PreferenceFragment implements
	...
	private static final NodePreference[] NODES = {
			...
			new NodePreference("set_tip_sound", 0xa701, 0x4000, 0xff, 0,
					R.array.low_speed_warning_tone_entries, R.array.three_values),
			new NodePreference("outside_lights_close_time", 0xa702, 0x4001, 0xff, 0,
					R.array.enheadlight_off_timer, R.array.five_values),
			new NodePreference("inner_lights_close_time", 0xa703, 0x4002, 0xff, 0,
					R.array.external_lighting_delay_off, R.array.five_values),
			new NodePreference("automatic_speed_lock", 0xa704, 0x4003, 0xff, 0,
					R.array.jac_automatic_speed_lock, R.array.three_values),

			new NodePreference("fortification_prompt_sound", 0xa705, 0x4004, 0xff, 0),
			new NodePreference("Positioning_lighting", 0xa706, 0x4005, 0xff, 0),
			


			new NodePreference("alert_volume", 0xa709, 0x4008, 0xff, 0,
					R.array.three_high_values, R.array.three_values),
					
			new NodePreference("automatic_window_lowering_by_remote_control", 0xa70a, 0x4009, 0xff, 0),
			new NodePreference("remote_mirror_fold", 0xa70c, 0x400b, 0xff, 0),
			new NodePreference("reverse_mirror_flip", 0xa70d, 0x400c, 0xff, 0),
			new NodePreference("function_seat", 0xa70e, 0x400d, 0xff, 0),
			
			
			new NodePreference("vol_radar", 0xa70f, 0x400e, 0xff, 0,
					R.array.five_high_values, R.array.five_high_values),
			new NodePreference("radar_warning_tone", 0xa710, 0x400f, 0xff, 0,
					R.array.five_high_values, R.array.five_high_values),

...
public class Set230 extends PreferenceFragment implements
	...
	private static final NodePreference[] NODES = {
			...
			new NodePreference("redar", 0x9201, 0x2900, 0x1, 0),
			new NodePreference("remote_lift_window", 0x9203, 0x2900, 0x10, 0),
			new NodePreference("remote_drop_window", 0x9204, 0x2900, 0x20, 0),
			new NodePreference(
					"long_press_micro_switch_unlocking_lifting_window", 0x9205,
					0x2900, 0x40, 0),
			new NodePreference(
					"lower_window_unlocked_by_long_press_micro_switch", 0x9206,
					0x2900, 0x80, 0),
			new NodePreference("outside_automatic_folding_of_rearview_mirror",
					0x9207, 0x2902, 0x1, 0),
			new NodePreference("zhonghua_xx", 0x9208, 0x2902,
					0x2, 0),
			new NodePreference("driver_seat_auto_return", 0x9209, 0x2902, 0x4, 0),
			new NodePreference("str_turn_mode", 0x920a, 0x2902, 0x8, 0),
			
			new NodePreference("str_remote_unlock", 0x920b, 0x2902, 0x10, 0,
					R.array.auto_unlock_setting_for_near_car_entries,
					R.array.two_values),

			new NodePreference("go_home_lighting_delay", 0x920c, 0x2902, 0xe0,
					0, R.array.byd_go_home, R.array.eight_values),
			new NodePreference("leave_home_lighting_delay", 0x920d, 0x2903,
					0x07, 0, R.array.byd_go_home, R.array.eight_values),
	//group2
					...
					new NodePreference("in_car_inspection", 0x9301, 0x2a05, 0x40, 1),
					new NodePreference("outside_inspection", 0x9302, 0x2a05, 0x80, 1),
					new NodePreference("power_on_detection", 0x9303, 0x2a00, 0x80, 1),
					new NodePreference("door_detection", 0x9304, 0x2a00, 0x20, 1),
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (!mPaused) {
				...
				byte[] buf = new byte[] { (byte) 0x90, (byte) 4,
						(byte) (msg.what & 0xff), 0, 0, 0 };

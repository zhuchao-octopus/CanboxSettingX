...
public class Set243 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    private static final String TAG = "HYSettingsRaiseFragment";

    private static final NodePreference[] NODES = {

            new NodePreference("air_purification_testing_frequency", 0x8a01, 0x2800, 0x04, 0, R.array.air_purification_testing_frequency_entries, R.array.two_values), new NodePreference("air_quality_alarm", 0x8a02, 0x2800, 0x03, 0, R.array.air_quality_alarm_entries, R.array.four_values),

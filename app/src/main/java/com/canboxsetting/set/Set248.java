...
public class Set248 extends PreferenceFragment implements
		Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
	private static final String TAG = "HYSettingsRaiseFragment";

	private static final NodePreference[] NODES = {

			new NodePreference("ambient_lighting", 0x8401, 0x1a00, 0xff, 0,
					R.array.yema_brightness_entries,
					R.array.three_values),
			new NodePreference("ambient_lighting_color", 0x8402, 0x1a01, 0xff, 0,
					R.array.yema_display_color_entries, R.array.five_values),
			new NodePreference("ambient_lighting_brightness", 0x8403, 0x1a02, 0xff, 0,
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (!mPaused) {
				...
				byte[] buf = new byte[] { (byte) 0x90, (byte) 1,
						(byte) (msg.what & 0xff) };

...
public class Set261 extends PreferenceFragment implements
		Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
	private static final String TAG = "HYSettingsRaiseFragment";

	private static final NodePreference[] NODES = {
										
			new NodePreference("parking_volume", 0x6f01, 0x6100, 0xf0, 0,
					R.array.sixteen_values, R.array.sixteen_values),

			new NodePreference("parking_delays", 0x6f02, 0x6100, 0x0c, 0,
					R.array.tata_2, R.array.three_values),

			new NodePreference("parking_sound_type", 0x6f03, 0x6100, 0x03, 0,
					R.array.sound_mode_entries, R.array.three_values),

			new NodePreference("door_unlock", 0x6f04, 0x6101, 0x80, 0,
					R.array.nearly_unclock, R.array.two_values),

			new NodePreference("auto_relock", 0x6f05, 0x6101, 0x40, 0),

			new NodePreference("headlight_off", 0x6f06, 0x6101, 0x30, 0,
					R.array.honda_security_relock_timer_entries,
					R.array.three_values),

			new NodePreference("atmosphere_lamp_opening", 0x6f07, 0x6102, 0xc0,
					0, R.array.yema_brightness_entries,
					R.array.three_values),
				
		new NodePreference("ambient_light_front", 0x6f08, 0x6102, 0x20, 0),
		new NodePreference("ambient_light_rear", 0x6f09, 0x6102, 0x10, 0),
		
			
			new NodePreference("ambient_light_color", 0x6f0a, 0x6102,
					0x0e, 0, R.array.tata_a,
					R.array.eight_values),
			new NodePreference("ambient_light_brightness", 0x6f0b, 0x6103,
					0xe0, 0, R.array.five_high_values,

...
public class Set264 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    private static final String TAG = "HYSettingsRaiseFragment";

    private static final NodePreference[] NODES = {


            new NodePreference("auto_lamp", 0x6f01, 0x6100, 0x1, 0), new NodePreference("auto_wipe", 0x6f02, 0x6100, 0x2, 0),

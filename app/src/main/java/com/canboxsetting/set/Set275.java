...
public class Set275 extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final NodePreference[] NODES = {
            ...
            new NodePreference("remote_unlock", 0x8800, 0x6600, 0x80, 0, R.array.door_to_be_unlocked_entries, R.array.two_values),

            new NodePreference("psa_simple_19", 0x8801, 0x6600, 0x40, 0), new NodePreference("parkunlock", 0x8802, 0x6600, 0x20, 0),

            new NodePreference("headlight_delay", 0x8803, 0x6601, 0xe0, 0, R.array.headlight_delay_oushange, R.array.five_values),

            new NodePreference("light_one_key_turn", 0x8804, 0x6601, 0xe0, 0, R.array.light_one_key_turn_entries, R.array.four_values),
            ...
            new NodePreference("lane_assist_warning_method", 0x8815, 0x6608, 0x0c, 0, R.array.lane_assist_warning_method_entries, R.array.three_high_values),

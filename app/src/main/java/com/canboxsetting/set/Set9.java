...
public class Set9 extends PreferenceFragment implements
		Preference.OnPreferenceChangeListener {
	private static final String TAG = "Set275";

	private static final NodePreference[] NODES = {

	new NodePreference("car_type_cmd", 0x7501, 0x2700, 0xff, 0,
			R.array.parking_sound_type_entries, R.array.three_values),

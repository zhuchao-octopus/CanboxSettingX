...
public class SiWeiSetingsRaiseFragment extends PreferenceFragment implements
	...
	private static final NodePreference[] NODES = {
			...
			new NodePreference("early_warning_moving_objects", 0xc603, 0x41,
					0x0008, 0),
			new NodePreference("door_opening_warning", 0xc604, 0x41, 0x0004, 0),
			new NodePreference("blind_spot_monitoring", 0xc605, 0x41, 0x0010, 0),

			new NodePreference("forward_collision_sensitivity", 0xc606, 0x41,
					0x0160, 0, R.array.jac_fortification_prompt_sound,
					R.array.honda_entryValues),

			new NodePreference("gac_settings_departure_waring", 0xc607, 0x41,
					0x0118, 0, R.array.jac_fortification_prompt_sound,
					R.array.honda_entryValues),

					
					new NodePreference("theme_color", 0xc608, 0x41, 0x0003, 0,
							R.array.swee_color_theme_entries,
							R.array.honda_entryValues),
	
			new NodePreference("langauage5", 0xc609, 0x41, 0x0104, 0,
					R.array.launage_entries3, R.array.launage_entryValues3),

			new NodePreference("ambient_light_switch", 0xc60b, 0x41, 0x0102, 0),

			new NodePreference("flow_me_home", 0xc60c, 0x41, 0x00e0, 0,
					R.array.external_lighting_delay_off,
					R.array.honda_entryValues),

			new NodePreference("steering_effort", 0xc60d, 0x41, 0x0180, 1,

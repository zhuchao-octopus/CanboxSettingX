...
public class SubaruSimpleSettingFragment extends PreferenceFragment implements
		Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
	private static final String TAG = "SubaruSimpleSettingFragment";

	private static final Node[] NODES = {

		new Node("lightingtime", 0xc603, 0x40, 0xc0, 0x0),
		new Node("subaru_settings_1", 0xc604, 0x40, 0x20, 0x0),
		new Node("subaru_settings_2", 0xc605, 0x40, 0x10, 0x0),
		new Node("subaru_settings_3", 0xc606, 0x40, 0x8, 0x0),
		new Node("subaru_settings_4", 0xc607, 0x40, 0x7, 0x0),
		new Node("auto_door", 0xc608, 0x40, 0xc000, 0x0),
		new Node("automatic", 0xc609, 0x40, 0x3000, 0x0),
		new Node("subaru_settings_5", 0xc60a, 0x40, 0x100, 0x0),
	};

...
public class ToyotaSetingHiworldFragment extends PreferenceFragment implements
...
//空调&灯光
		new Node("inner_outer_auto", 0x6A0107, 0x62010000, 0x0100, 0,
				Node.TYPE_BUFF1),
		
		new Node("air_auto", 0x6A0106, 0x62010000, 0x0200, 0,
				Node.TYPE_BUFF1),
						
		new Node("auto_adjust_head_light_sensity", 0x6A0301, 0x62010000, 0x07000000, 0,
				Node.TYPE_BUFF1),
						
		new Node("inner_lights_close_time", 0x6A0302, 0x62010000, 0x18000000, 0,
				Node.TYPE_BUFF1),
				
		new Node("outside_lights_close_time", 0x6A0303, 0x62010000, 0x60000000, 0,
				Node.TYPE_BUFF1),
								
		new Node("radar_display", 0x6A0108, 0x62010000, 0x80, 0,
				Node.TYPE_BUFF1),
				
		new Node("radar_distance", 0x6A010A, 0x62010000, 0x03, 0,
				Node.TYPE_BUFF1),
						
		new Node("alarm_volume", 0x6A0109, 0x62010000, 0x70, 0,
				Node.TYPE_BUFF1),
										
		new Node("front_radar_distance", 0x6A010A, 0x62010000, 0x0C, 0,
				Node.TYPE_BUFF1),						
//车锁设置
		new Node("auto_lock_by_speed", 0x6A0101, 0x62010000, 0x4000, 0,
				Node.TYPE_BUFF1),
				
		new Node("cardoorautomatic", 0x6A0105, 0x62010000, 0x0400, 0,
				Node.TYPE_BUFF1),
								
		new Node("plinkage", 0x6A0104, 0x62010000, 0x0800, 0,
				Node.TYPE_BUFF1),
								
		new Node("unlock_double_operate", 0x6A0204, 0x62010000, 0x400000, 0,
				Node.TYPE_BUFF1),
						
		new Node("lock_unlock_blink", 0x6A0201, 0x62010000, 0x800000, 0,
				Node.TYPE_BUFF1),
										
		new Node("auto_lock_and_one_key_start", 0x6A0202, 0x62010000, 0x200000, 0,
				Node.TYPE_BUFF1),
						
		new Node("smartdoorlock", 0x6A0102, 0x62010000, 0x2000, 0,
				Node.TYPE_BUFF1),
								
		new Node("unlock_driver_door_open", 0x6A0103, 0x62010000, 0x1000, 0,
				Node.TYPE_BUFF1),
												
		new Node("unlock_double_key", 0x6A0203, 0x62010000, 0x100000, 0,
				Node.TYPE_BUFF1),		
//原车设置
...
//			Node.TYPE_BUFF1),
//功放设置		
		new Node("speed_linkage_volume", 0xAD07, 0xA6020000, 0x020000, 0,
				Node.TYPE_BUFF1),

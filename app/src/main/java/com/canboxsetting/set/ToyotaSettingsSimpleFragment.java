...
public class ToyotaSettingsSimpleFragment extends PreferenceFragment implements
	...
	private static final Node[] NODES = {
		...
		new Node("cardoorspeed", 0x8300, 0x26000000, 0x8000, 0x0),
		new Node("cardoorautomatic", 0x8301, 0x26000000, 0x4000, 0x0),
		new Node("plinkage", 0x8302, 0x26000000, 0x2000, 0x0),
		
		new Node("remoteunlock", 0x8303, 0x26000000, 0x1000, 0x0),
		new Node("smartdoorlock", 0x830f, 0x26000000, 0x200000, 0x0),		
		new Node("lockakey", 0x8310, 0x26000000, 0x100000, 0x0),
		new Node("opendoorflash", 0x8311, 0x26000000, 0x80000, 0x0),
		new Node("doorlockvol", 0x8305, 0x26000000, 0x700, 0x0),
		
		new Node("twokeyunlock", 0x830d, 0x26000000, 0x800000, 0x0),
		new Node("linkagedoorlock", 0x830e, 0x26000000, 0x400000, 0x0),		
		new Node("closedoortime", 0x8314, 0x26000000, 0x3000000, 0x0),
		
		
		new Node("airautokey", 0x8312, 0x26000000, 0x80000000, 0x0),
		new Node("airswitchautokey", 0x8313, 0x26000000, 0x40000000, 0x0),
		
		new Node("autolight", 0x8306, 0x26000000, 0x70, 0x0),
		new Node("timeswitchlight", 0x8307, 0x26000000, 0x03, 0x0),
		new Node("lightingtime", 0x830c, 0x26000000, 0x0c, 0x0),
		new Node("daylight", 0x8304, 0x26000000, 0x80, 0x0),
		
		new Node("radarvol", 0x8315, 0x1e000000, 0x7, 0, Node.TYPE_BUFF1),//to  do..		
		new Node("radardisplay", 0x8316, 0x1e000000,  0x80, 0, Node.TYPE_BUFF1),		
		new Node("radarrange", 0x8317, 0x1e000000,  0x40, 0, Node.TYPE_BUFF1),
		
		
		new Node("setting_color", 0x8318, 0x26000000, 0x30000000, 0x0),
		new Node("setings_unit", 0x8319, 0x26000000, 0x800, 0x0),
		new Node("back_camera_path", 0x8322, 0x26000000, 0xc000000, 0x0),
		new Node("cell_back_door", 0x8323, 0x26000000, 0x70000, 0x0),

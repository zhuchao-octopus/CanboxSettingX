...
public class VWMQBSettingsRaiseFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private static final Node[] NODES = {
            ...
            new Node("all_settings_key", 0xc6c701, 0, 0), new Node("driver_assist_key", 0xc6c101, 0, 0), new Node("parking_and_manoeuvring_key", 0xc6c201, 0, 0),
            new Node("lights_key", 0xc6c301, 0, 0), new Node("mirrors_and_wipers_key", 0xc6c401, 0, 0), new Node("opening_and_closing_key", 0xc6c501, 0, 0),
            new Node("multifunction_display_key", 0xc6c601, 0, 0), new Node("ambient_lighting_reset", 0xc6c901, 0, 0), new Node("electric_driving_charging_hybrid", 0xc6ca01, 0, 0),
            ...
            new Node("brightness_of_variable_channel_auxiliary_system", 0xc63f, 0x40310000, 0xf00000), new Node("preventive_member_protection_system_key", 0xc63e, 0x40300000, 0x200),
            ...
            new Node("accrdriveprogram", 0xc637, 0x40310000, 0xf00, 0x0), new Node("accvehicle", 0xc638, 0x40310000, 0xf000, 0x0),
            ...
            new Node("rearrain", 0xc663, 0x40600000, 0x8), new Node("wiper_maintenance_position_key", 0xc68c, 0x63220000, 0x1), new Node("parking", 0xc664, 0x40600000, 0x100),

            new Node("acousticconfirmation", 0xc675, 0x40700000, 0x4000), new Node("windowsopen", 0xc670, 0x40700000, 0xf), new Node("centrallock", 0xc671, 0x40700000, 0xf0),
            new Node("autolock", 0xc672, 0x40700000, 0x100),

            new Node("remote_control_key_memory_matching", 0xc6CB, 0x40B00000, 0x2), new Node("driver_seat_key", 0xc6C9, 0x40B00000, 0x4), new Node("front_window_key", 0xc666, 0x40700000, 0x400),
            new Node("rear_window_key", 0xc667, 0x40700000, 0x800), new Node("sliding_window_key", 0xc668, 0x40700000, 0x1000), new Node("induction_rear_rear_cover", 0xc674, 0x40700000, 0x200),
            ...
            new Node("individual", 0xc6a0, 0x40b20000, 0x80), new Node("user_account_key", 0xc6a1, 0x40b20000, 0x70), new Node("key_distribution_key", 0xc6a2, 0x40b20000, 0x8),
            new Node("assign_the_key_the_current_user_account_key", 0xc6a3, 0x0, 0x0),
    ...
    private final static int[] INIT_CMDS = {
            0x6310, 0x6311, 0x6320, 0x6321, 0x6322, 0x6300, 0x4000, 0x4010, 0x4020, 0x4030, 0x4031, 0x4040, 0x4050, 0x4051, 0x4052, 0x4053, 0x4060, 0x4070, 0x4080, 0x4090, 0x40a0, 0x40b0, 0x40b1,
            0x40b2, 0x40c0, 0x40c1, 0x51ff, 0x5080,
            /*

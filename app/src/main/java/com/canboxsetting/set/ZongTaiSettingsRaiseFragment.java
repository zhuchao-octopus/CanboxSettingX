...
public class ZongTaiSettingsRaiseFragment extends PreferenceFragment implements
...
//data0
		new Node("seat_courtesy", 0xc693, 0x41000000, 0x04, 0,
				Node.TYPE_BUFF1),
				
		new Node("ambient_light", 0xc694, 0x41000000, 0x08, 0,
				Node.TYPE_BUFF1),
				
		new Node("ambient_light_brightness", 0xc695, 0x41000000, 0xF0, 0,
				Node.TYPE_BUFF1),
		
		new Node("flow_me_home", 0xc696, 0x41000000, 0x0800, 0,
				Node.TYPE_BUFF1),
		
		new Node("flow_me_home_times", 0xc696, 0x41000000, 0xF000, 0,
				Node.TYPE_BUFF1),
		
		new Node("gac_settings_departure_waring", 0xc697, 0x41000000, 0x0400, 0,
				Node.TYPE_BUFF1),
				
		new Node("headlight_height", 0xc698, 0x41000000, 0x0300, 0,
				Node.TYPE_BUFF1), 

				
//data1
		new Node("ambient_lighting", 0xc699, 0x41000000, 0x800000, 0,
				Node.TYPE_BUFF1), 
		
		new Node("ambient_lighting_brightness", 0xc69A, 0x41000000, 0x700000, 0,
				Node.TYPE_BUFF1), 
		
		new Node("ambient_lighting_color", 0xc69B, 0x41000000, 0x0F0000, 0,
				Node.TYPE_BUFF1), 	
				
			new Node("original_car_cd_source_switch", 0xd000, 0x24000000, 0x80000000, 0,
					Node.TYPE_BUFF1),

...
public class SlimVehicleSetting extends MyFragment {
    ...
    private static final int[] iconIds = new int[]{
            ...
            R.mipmap.slim_vehicle_sound_lock_icon,
            R.mipmap.slim_vehicle_battery_icon,
            R.mipmap.slim_vehicle_phone_icon,
            R.mipmap.slim_vehicle_instrument_icon,
            R.mipmap.slim_vehicle_time_icon,
            R.mipmap.slim_vehicle_language_icon};
    private static final int[] settingNames = new int[]{R.string.around_view_monitor,
            R.string.smart_car_door_lock,
            R.string.auto_folding_of_outer_reaview_mirror,
            R.string.aemergency_brake_warning_light,
            R.string.security_tips,
            R.string.wireless_charging,
            R.string.mobile_forgotten_tips,
            R.string.meter_setting,
            R.string.clock_setting,
            R.string.car_language};
    private static final SlimVehicleSettingAdapter.SlimVehicleSettingType[] types = new SlimVehicleSettingAdapter.SlimVehicleSettingType[]{SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE1,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE1,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE2,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE2,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE1,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE2,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE2,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE1,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE1,
            SlimVehicleSettingAdapter.SlimVehicleSettingType.TYPE3};

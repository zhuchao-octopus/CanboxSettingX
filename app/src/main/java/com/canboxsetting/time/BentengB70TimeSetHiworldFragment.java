...
public class BentengB70TimeSetHiworldFragment extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater.inflate(R.layout.bentengb70_timeset_hiworld, container,
				false);


		mMainView.findViewById(R.id.hour_a)
				.setOnTouchListener(mOnTouchListener);
		mMainView.findViewById(R.id.hour_m)
				.setOnTouchListener(mOnTouchListener);
		mMainView.findViewById(R.id.min_a)
				.setOnTouchListener(mOnTouchListener);
		mMainView.findViewById(R.id.min_m)
				.setOnTouchListener(mOnTouchListener);
		mMainView.findViewById(R.id.set24)
				.setOnTouchListener(mOnTouchListener);
		mMainView.findViewById(R.id.set12)
				.setOnTouchListener(mOnTouchListener);

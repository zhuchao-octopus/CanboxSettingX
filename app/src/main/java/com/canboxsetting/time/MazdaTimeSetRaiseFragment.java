...
public class MazdaTimeSetRaiseFragment extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater.inflate(R.layout.mazda_timeset_raise, container,
				false);

		mMainView.findViewById(R.id.time_clock).setOnTouchListener(
				mOnTouchListener);
		// mMainView.findViewById(R.id.time_set).setOnTouchListener(
		// mOnTouchListener);
		mMainView.findViewById(R.id.time_h)
				.setOnTouchListener(mOnTouchListener);
		mMainView.findViewById(R.id.time_m)
				.setOnTouchListener(mOnTouchListener);

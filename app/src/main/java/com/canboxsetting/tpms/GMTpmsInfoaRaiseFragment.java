    ...
    private void updateView(byte[] buf) {
        ...
        switch (buf[0]) {
            case 0x4a:
                ...
                break;
            case 0x68: //hiworld
                setTpmsTextValue(R.id.type11_num, (((buf[3] & 0xff) << 8) | (buf[4] & 0xff)), 0);
                setTpmsTextValue(R.id.type12_num, (((buf[5] & 0xff) << 8) | (buf[6] & 0xff)), 0);
                setTpmsTextValue(R.id.type21_num, (((buf[7] & 0xff) << 8) | (buf[8] & 0xff)), 0);
                setTpmsTextValue(R.id.type22_num, (((buf[9] & 0xff) << 8) | (buf[10] & 0xff)), 0);

...
public class RenaultTPMSRaiseFragment extends PreferenceFragmentCompat implements OnPreferenceClickListener {
    ...
    private void setTpmsTextValue(int id, int value, int color) {
        ...
        if (value == 0xff) {
            ...
            value = value * 3;
            text = String.format("%d.%02d  kPa", value / 100, value % 100);
        }
    ...
    private void updateView(byte[] buf) {
        ...
        switch (buf[0]) {
            case 0x61:
                ...
                String ss[] = getResources().getStringArray(R.array.renault_tire_tips_or_warnings_entries);

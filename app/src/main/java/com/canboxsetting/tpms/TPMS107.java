        ...
        switch (buf[0]) {
            case (byte) 0x48:
                ...
                if (mTpmsView != null) {
                    ...
                    setTpmsTextInfo(R.id.type11_num, (buf[4] & 0xff) + (buf[9] & 0xff), mColor & 0xff);
                    setTpmsTextInfo(R.id.type12_num, (buf[5] & 0xff) + (buf[10] & 0xff), (mColor & 0xff00) >> 8);
                    setTpmsTextInfo(R.id.type21_num, (buf[6] & 0xff) + (buf[11] & 0xff), (mColor & 0xff0000) >> 16);
                    setTpmsTextInfo(R.id.type22_num, (buf[7] & 0xff) + (buf[12] & 0xff), (mColor & 0xff000000) >> 24);

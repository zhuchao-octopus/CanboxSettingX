...
public class TPMS163 extends PreferenceFragment {
        ...
        switch (buf[0]) {
            case (byte) 0xd2:
                ...
                if (mTpmsView != null) {
                    ...
                    setTpmsTextValue(R.id.type11_num, buf[4] & 0x7f, 0);
                    setTpmsTextValue(R.id.type12_num, buf[8] & 0x7f, 0);
                    setTpmsTextValue(R.id.type21_num, buf[12] & 0x7f, 0);


                    setTpmsTextInfo(R.id.type11_info, buf[3] & 0x3f, 0);
                    setTpmsTextInfo(R.id.type12_info, buf[7] & 0x3f, 0);
                    setTpmsTextInfo(R.id.type21_info, buf[11] & 0x3f, 0);
                    ...
                    if (buf.length > 16) {
                        ...
                        setTpmsTextValue(R.id.type22_num, buf[16] & 0x7f, 0);
                        setTpmsTextInfo(R.id.type22_info, buf[17] & 0x3f, 0);

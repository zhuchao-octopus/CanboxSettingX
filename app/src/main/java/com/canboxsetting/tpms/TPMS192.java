...
//			value = 1373 * value;
	...
	final static int []WARNING = {
		0,
		R.string.system_self_test,
		R.string.str_quick_leakage,
		R.string.str_slow_leakage,

		R.string.landwind_Tire_pressure_high,
		R.string.landwind_Tire_pressure_low,
		
		R.string.temp_high_more,
		R.string.str_temp_warning,
		R.string.str_low_battery,
	};
		...
		case (byte)0x37:
			...
			if (mTpmsView != null) {
				...
				case 0:
					switch (buf[2]) {
					case 0:
						setTpmsTextInfoOD(R.id.type11_num, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					case 1:
						setTpmsTextInfoOD(R.id.type12_num, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					case 2:
						setTpmsTextInfoOD(R.id.type21_num, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					case 3:
						setTpmsTextInfoOD(R.id.type22_num, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					}
					break;
				...
				case 1:
					switch (buf[2]) {
					case 0:
						setTpmsTextValue(R.id.type11_info, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					case 1:
						setTpmsTextValue(R.id.type12_info, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					case 2:
						setTpmsTextValue(R.id.type21_info, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					case 3:
						setTpmsTextValue(R.id.type22_info, (buf[5] & 0xff)
								| ((buf[4] & 0xff) << 8), 0);
						break;
					}
					break;
